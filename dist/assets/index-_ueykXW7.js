...
import{X as jt}from"./vendor-db-2jmnBxhj.js";import{_ as V}from"./vendor-pdf-j4-ZKoBl.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();const E=new jt("BlueMountainPOS");E.version(2).stores({products:"++id, category",transactions:"++id, dateKey, paymentStatus, paymentMethod",settings:"key",expenses:"++id, dateKey, category"});const z=()=>E.products.toArray(),Tt=t=>E.products.add(t),Rt=t=>E.products.put(t),Kt=t=>E.products.delete(t),Ot=t=>E.transactions.add(t),X=()=>E.transactions.toArray(),Ht=t=>E.transactions.delete(t),Y=t=>E.transactions.put(t),Ft=t=>E.expenses.add(t),_t=()=>E.expenses.toArray(),qt=t=>E.expenses.delete(t),ct=async t=>{const e=await E.settings.get(t);return(e==null?void 0:e.value)??null},rt=(t,e)=>E.settings.put({key:t,value:e}),Gt=async()=>{await E.products.count()>0||await E.products.bulkAdd([{name:"Air Isi Ulang Galon",category:"Galon",price:5e3,unit:"galon",emoji:"🪣",stock:999},{name:"Antar Galon (dalam)",category:"Galon",price:3e3,unit:"kali",emoji:"🛵",stock:999},{name:"Antar Galon (luar)",category:"Galon",price:5e3,unit:"kali",emoji:"🚚",stock:999},{name:"Galon Baru (Aqua)",category:"Galon",price:5e4,unit:"buah",emoji:"💧",stock:50},{name:"Galon Baru (Standar)",category:"Galon",price:45e3,unit:"buah",emoji:"💦",stock:50},{name:"Air Botol 600ml",category:"Botol",price:3e3,unit:"botol",emoji:"🍶",stock:200},{name:"Air Botol 1500ml",category:"Botol",price:5e3,unit:"botol",emoji:"🥤",stock:100},{name:"Dispenser Galon",category:"Lainnya",price:25e4,unit:"unit",emoji:"⚗️",stock:10}])},Ut=async()=>{await Promise.all([E.products.clear(),E.transactions.clear(),E.expenses.clear(),E.settings.clear()]),sessionStorage.clear(),localStorage.clear()},Jt=async()=>{const[t,e,s,n]=await Promise.all([E.products.toArray(),E.transactions.toArray(),E.expenses.toArray(),E.settings.toArray()]),a=n.find(i=>i.key==="shopName"),o=(a==null?void 0:a.value)||"Blue Mountain";return{app:"Blue Mountain POS",version:"3.0.0",exportedAt:new Date().toISOString(),shopName:o,data:{products:t,transactions:e,expenses:s,settings:n},meta:{productCount:t.length,transactionCount:e.length,expenseCount:s.length,settingCount:n.length}}},Wt=async(t,e="replace")=>{if(!t||!t.data)throw new Error("Format file backup tidak valid atau rusak.");const{products:s=[],transactions:n=[],expenses:a=[],settings:o=[]}=t.data;return e==="replace"?(await Promise.all([E.products.clear(),E.transactions.clear(),E.expenses.clear(),E.settings.clear()]),s.length&&await E.products.bulkAdd(s),n.length&&await E.transactions.bulkAdd(n),a.length&&await E.expenses.bulkAdd(a),o.length&&await E.settings.bulkPut(o)):e==="merge"&&(s.length&&await E.products.bulkPut(s),n.length&&await E.transactions.bulkPut(n),a.length&&await E.expenses.bulkPut(a),o.length&&await E.settings.bulkPut(o)),{products:s.length,transactions:n.length,expenses:a.length,settings:o.length}},Vt=()=>E.open(),C={},g={state:{cart:[],products:[],transactions:[],expenses:[],currentView:"pos",discount:0,customerName:"",settings:{shopName:"Blue Mountain Refilling Station",shopAddress:"Jl. Contoh No. 1, Kota",shopPhone:"0812-3456-7890",cashierName:"Admin",printerUrl:"",printEnabled:!1,taxRate:0,bankName:"BCA",bankNumber:"",bankHolder:"Blue Mountain Refilling Station",qrisNumber:"",modalAwal:0}},on(t,e){return(C[t]??(C[t]=[])).push(e),()=>{C[t]=(C[t]??[]).filter(s=>s!==e)}},emit(t,e){(C[t]??[]).forEach(s=>s(e))},addToCart(t,e=1){const s=Math.max(1,parseInt(e)||1),n=this.state.cart.findIndex(a=>String(a.product.id)===String(t.id));n>=0?this.state.cart[n].qty+=s:this.state.cart.push({product:t,qty:s}),this.emit("cart:change",this.state.cart)},removeFromCart(t){this.state.cart=this.state.cart.filter(e=>String(e.product.id)!==String(t)),this.emit("cart:change",this.state.cart)},setQty(t,e){if(e<=0)return this.removeFromCart(t);const s=this.state.cart.find(n=>String(n.product.id)===String(t));s&&(s.qty=e,this.emit("cart:change",this.state.cart))},clearCart(){this.state.cart=[],this.state.discount=0,this.state.customerName="",this.emit("cart:change",this.state.cart)},setDiscount(t){this.state.discount=Math.max(0,parseFloat(t)||0),this.emit("cart:change",this.state.cart)},setCustomerName(t){this.state.customerName=String(t??"").slice(0,80)},get subtotal(){return this.state.cart.reduce((t,e)=>t+e.product.price*e.qty,0)},get tax(){return Math.round(this.subtotal*(this.state.settings.taxRate||0)/100)},get total(){return Math.max(0,this.subtotal+this.tax-this.state.discount)},get cartCount(){return this.state.cart.reduce((t,e)=>t+e.qty,0)},setProducts(t){this.state.products=t,this.emit("products:change",t)},setTransactions(t){this.state.transactions=t,this.emit("transactions:change",t)},removeTransaction(t){this.state.transactions=this.state.transactions.filter(e=>e.id!==t),this.emit("transactions:change",this.state.transactions)},addTransaction(t){this.state.transactions=[t,...this.state.transactions],this.emit("transactions:change",this.state.transactions)},updateTransaction(t,e){const s=this.state.transactions.findIndex(n=>n.id===t);s>=0&&(this.state.transactions[s]={...this.state.transactions[s],...e},this.emit("transactions:change",this.state.transactions))},setExpenses(t){this.state.expenses=t,this.emit("expenses:change",t)},addExpense(t){this.state.expenses=[...this.state.expenses,t],this.emit("expenses:change",this.state.expenses)},removeExpense(t){this.state.expenses=this.state.expenses.filter(e=>e.id!==t),this.emit("expenses:change",this.state.expenses)},navigate(t){this.state.currentView=t,this.emit("navigate",t)},updateSettings(t){Object.assign(this.state.settings,t),this.emit("settings:change",this.state.settings)}},Yt=(t=new Date)=>new Intl.DateTimeFormat("id-ID",{weekday:"long",year:"numeric",month:"long",day:"numeric"}).format(t instanceof Date?t:new Date(t)),Qt=(t=new Date)=>new Intl.DateTimeFormat("id-ID",{year:"numeric",month:"2-digit",day:"2-digit"}).format(t instanceof Date?t:new Date(t)),Et=(t=new Date)=>new Intl.DateTimeFormat("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(t instanceof Date?t:new Date(t)),Z=(t=new Date)=>`${Qt(t)} ${Et(t)}`,U=()=>new Date().toISOString().split("T")[0],Xt=()=>{const t=new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`},p=t=>isNaN(t)?"Rp 0":"Rp "+Math.round(t).toLocaleString("id-ID"),f=t=>t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),pt=(t,e)=>{const s=t.items||[],n=[],a=(d,l=0,r=1,c=0)=>n.push({type:0,content:d,bold:l,align:r,format:c}),o=()=>a("--------------------------------",0,1,0),i=()=>a(" ",0,0,0);i(),a(e.shopName||"Blue Mountain Refilling Station",1,1,2),a(e.shopAddress||"",0,1,4),e.shopPhone&&a(`Telp: ${e.shopPhone}`,0,1,4),o(),a(`No: ${t.invoiceNo||"-"}`,0,0,0),a(`Tgl: ${Z(new Date(t.date))}`,0,0,0),t.customerName&&a(`Pelanggan: ${t.customerName}`,0,0,0),t.cashier&&a(`Kasir: ${t.cashier}`,0,0,0),o();for(const d of s){if(!(d!=null&&d.product))continue;const l=d.product.name,r=d.qty,c=p(d.product.price),y=p(d.product.price*r);a(`${l}`,0,0,0),a(`  ${r} x ${c} = ${y}`,0,0,0)}return o(),t.discount>0&&(a(`Subtotal: ${p(t.subtotal)}`,0,0,0),a(`Diskon:  -${p(t.discount)}`,0,0,0)),t.tax>0&&a(`Pajak:    ${p(t.tax)}`,0,0,0),a(`TOTAL: ${p(t.total)}`,1,0,3),t.paymentMethod==="cash"?(a(`Bayar:   ${p(t.paid)}`,0,0,0),a(`Kembali: ${p(t.change)}`,1,0,0)):t.paymentMethod==="transfer"?(a(`Transfer: ${p(t.total)}`,0,0,0),a(`Status: ${t.paymentStatus==="transfer_confirmed"?"TERKONFIRMASI":"MENUNGGU KONFIRMASI"}`,0,0,0)):t.paymentMethod==="debt"&&(a(`DP Dibayar: ${p(t.paidAmount||0)}`,0,0,0),a(`Sisa Hutang: ${p(t.remainingDebt||0)}`,1,0,0)),o(),i(),a("Terima kasih sudah berbelanja!",1,1,0),a(e.shopName||"Blue Mountain Refilling Station",0,1,4),i(),i(),n},St=()=>{const t=window.location.pathname.replace(/\/[^/]*$/,"/");return`${window.location.origin}${t}receipt-data.html`},Zt=t=>{const e=pt(t,g.state.settings);return sessionStorage.setItem("pendingReceipt",JSON.stringify(e)),St()},Pt=t=>(Zt(t),`my.bluetoothprint.scheme://${g.state.settings.printerUrl||St()}`),It=t=>{const e=g.state.settings,s=t.items||[],n=(d,l=!1,r="left")=>`<div style="text-align:${r};font-weight:${l?"bold":"normal"}">${d}</div>`,a=()=>'<div style="border-top:1px dashed #bbb;margin:5px 0"></div>',o=()=>"<div>&nbsp;</div>";let i="";i+=`<div style="text-align:center;margin-bottom:2px;margin-top:6px">
    ...
    <div class="modal-body">
      ...
      <div id="pay-cash-section" style="${t!=="cash"?"display:none":""}">
        ...
        <div class="quick-amounts" id="quick-amounts" style="margin-top:8px">
          ${te(e).map(c=>`<button class="quick-amt-btn" data-amount="${c}">${p(c)}</button>`).join("")}
        </div>
      ...
      <div id="pay-transfer-section" style="${t!=="transfer"?"display:none":""}">
        <div class="transfer-info">
          ...
          <div style="font-size:13px;color:var(--text-secondary)">a/n ${l}</div>
  ...
  `;L(r,"payment-modal"),setTimeout(()=>{var _,k,$,m;(_=document.getElementById("pay-close-btn"))==null||_.addEventListener("click",()=>P("payment-modal")),(k=document.getElementById("pay-cancel-btn"))==null||k.addEventListener("click",()=>P("payment-modal")),document.querySelectorAll(".pay-tab").forEach(v=>{v.addEventListener("click",()=>{document.querySelectorAll(".pay-tab").forEach(w=>w.classList.remove("active")),v.classList.add("active");const h=v.dataset.method;document.getElementById("pay-cash-section").style.display=h==="cash"?"":"none",document.getElementById("pay-transfer-section").style.display=h==="transfer"?"":"none",document.getElementById("pay-debt-section").style.display=h==="debt"?"":"none"})});const c=document.getElementById("cash-received"),y=()=>{const v=parseFloat(c==null?void 0:c.value)||0,h=Math.max(0,v-e),w=document.getElementById("change-amount");w&&(w.textContent=p(h))};c==null||c.addEventListener("input",y),y(),($=document.getElementById("quick-amounts"))==null||$.addEventListener("click",v=>{const h=v.target.closest(".quick-amt-btn");h&&c&&(c.value=h.dataset.amount,y())});const x=document.getElementById("debt-paid-now"),S=()=>{const v=Math.min(parseFloat(x==null?void 0:x.value)||0,e),h=e-v,w=document.getElementById("debt-paid-display"),b=document.getElementById("debt-remaining-display");w&&(w.textContent=p(v)),b&&(b.textContent=p(h))};x==null||x.addEventListener("input",S),(m=document.getElementById("pay-confirm-btn"))==null||m.addEventListener("click",async()=>{var T,B,M,N,A;const v=document.querySelector(".pay-tab.active"),h=(v==null?void 0:v.dataset.method)||"cash",w=document.getElementById("pay-confirm-btn");if(h==="cash"&&(parseFloat(c==null?void 0:c.value)||0)<e){window.showToast("Jumlah bayar kurang dari total!","warning");return}if(h==="debt"&&!((B=(T=document.getElementById("debt-customer"))==null?void 0:T.value)==null?void 0:B.trim())){window.showToast("Nama pelanggan wajib diisi untuk hutang!","warning");return}w&&(w.disabled=!0,w.textContent="⏳ Menyimpan...");const b=new Date().toISOString();let u;if(h==="cash"){const I=parseFloat(c==null?void 0:c.value)||e,K=Math.max(0,I-e);u={invoiceNo:et(),date:b,dateKey:U(),items:g.state.cart.map(q=>({product:{...q.product},qty:q.qty})),subtotal:s,discount:n,tax:a,total:e,paymentMethod:"cash",paymentStatus:"paid",paid:I,change:K,paidAmount:e,remainingDebt:0,debtPayments:[],customerName:g.state.customerName||"",cashier:g.state.settings.cashierName||"Admin"}}else if(h==="transfer")u={invoiceNo:et(),date:b,dateKey:U(),items:g.state.cart.map(I=>({product:{...I.product},qty:I.qty})),subtotal:s,discount:n,tax:a,total:e,paymentMethod:"transfer",paymentStatus:"transfer_pending",paid:0,change:0,paidAmount:0,remainingDebt:0,debtPayments:[],customerName:g.state.customerName||"",cashier:g.state.settings.cashierName||"Admin"};else{const I=Math.min(parseFloat((M=document.getElementById("debt-paid-now"))==null?void 0:M.value)||0,e),K=e-I,q=I===0?"unpaid":I<e?"partial":"paid",Dt=((A=(N=document.getElementById("debt-customer"))==null?void 0:N.value)==null?void 0:A.trim())||"";u={invoiceNo:et(),date:b,dateKey:U(),items:g.state.cart.map(yt=>({product:{...yt.product},qty:yt.qty})),subtotal:s,discount:n,tax:a,total:e,paymentMethod:"debt",paymentStatus:q,paid:I,change:0,paidAmount:I,remainingDebt:K,debtPayments:I>0?[{date:b,amount:I,note:"DP / Uang muka awal"}]:[],customerName:Dt,cashier:g.state.settings.cashierName||"Admin"}}try{const I=await Ot(u);u.id=I,g.addTransaction(u),P("payment-modal"),g.clearCart(),ee(u)}catch(I){window.showToast("Gagal menyimpan transaksi!","error"),console.error("[payment]",I),w&&(w.disabled=!1,w.innerHTML="✅ Proses Pembayaran")}})},0)},te=t=>{const s=(a=>Math.ceil(a/5e3)*5e3)(t),n=[s,s+5e3,s+1e4,s+2e4,s+5e4,s+1e5];return[...new Set(n.filter(a=>a>=t))].slice(0,4)},ee=t=>{var d,l,r;const e=pt(t,g.state.settings);sessionStorage.setItem("pendingReceipt",JSON.stringify(e));const s=g.state.settings.printEnabled,n=Pt(t),a=It(t),o=document.createElement("div");o.className="success-overlay",o.id="success-overlay",o.innerHTML=`
  ...
  `,document.body.appendChild(o);const i=()=>{o.classList.add("closing"),setTimeout(()=>o.remove(),180)};(d=document.getElementById("success-close-btn"))==null||d.addEventListener("click",i),(l=document.getElementById("btn-close-overlay"))==null||l.addEventListener("click",i),(r=document.getElementById("btn-new-tx"))==null||r.addEventListener("click",()=>{i(),window.showToast("Siap transaksi baru! 👍","success")}),setTimeout(()=>{o.parentNode&&i()},15e3)};let dt="",Q="Semua",G=null,ft=[];const ae=async()=>{const t=await z();g.setProducts(t),Bt(),G&&G.abort(),G=new AbortController,ft.forEach(e=>e()),ft=[g.on("cart:change",Lt),g.on("products:change",()=>F())],ie(G.signal)},Bt=()=>{const t=document.getElementById("view-pos");t.innerHTML=`
  ...
  `,ut(),F(),Lt()},ne=()=>["Semua",...new Set(g.state.products.map(t=>t.category))],ut=()=>{const t=document.getElementById("category-pills");t&&(t.innerHTML=ne().map(e=>`
  ...
  `).join(""),t.querySelectorAll(".product-card").forEach(s=>{const n=()=>{const a=s.dataset.id,o=g.state.products.find(i=>String(i.id)===String(a));o&&(g.addToCart(o),s.style.transform="scale(0.94)",setTimeout(()=>{s.style.transform=""},120))};s.addEventListener("click",n),s.addEventListener("keydown",a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),n())})})},Lt=()=>{const t=document.getElementById("cart-items"),e=document.getElementById("cart-count"),s=document.getElementById("cart-total"),n=document.getElementById("tax-amount"),a=document.getElementById("tax-row");if(!t)return;const o=g.state.cart;if(e){const i=e.textContent;e.textContent=g.cartCount,i!==String(g.cartCount)&&(e.classList.remove("bump"),e.offsetWidth,e.classList.add("bump"))}if(s&&(s.textContent=p(g.total)),a&&n&&(g.tax>0?(a.style.display="flex",n.textContent=p(g.tax)):a.style.display="none"),!o.length){t.innerHTML=`
    ...
    <div class="cart-item" data-pid="${i.product.id}">
      <div class="cart-item__info">
        <div class="cart-item__name">${i.product.emoji||""} ${f(i.product.name)}</div>
        <div class="cart-item__price">${p(i.product.price)} / ${f(i.product.unit)}</div>
      </div>
      <div class="cart-item__controls">
        <div class="cart-item__subtotal">${p(i.product.price*i.qty)}</div>
  ...
  `).join(""),t.querySelectorAll("[data-action]").forEach(i=>{i.addEventListener("click",()=>{const d=i.dataset.pid,l=i.dataset.action,r=g.state.cart.find(c=>String(c.product.id)===String(d));r&&(l==="inc"?g.setQty(r.product.id,r.qty+1):l==="dec"?g.setQty(r.product.id,r.qty-1):l==="remove"&&g.removeFromCart(r.product.id))})})},se=()=>{const t=`
    <div class="modal-header">
  ...
  `;L(t,"manual-item-modal"),setTimeout(()=>{var e,s,n,a;(e=document.getElementById("mi-close"))==null||e.addEventListener("click",()=>P("manual-item-modal")),(s=document.getElementById("mi-cancel"))==null||s.addEventListener("click",()=>P("manual-item-modal")),(n=document.getElementById("mi-name"))==null||n.focus(),document.querySelectorAll(".emoji-pick-mi").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".emoji-pick-mi").forEach(i=>{i.style.borderColor="var(--border-subtle)",i.classList.remove("emoji-pick--active")}),o.style.borderColor="var(--blue-400)",o.classList.add("emoji-pick--active"),document.getElementById("mi-emoji").value=o.dataset.emoji})}),(a=document.getElementById("mi-save"))==null||a.addEventListener("click",async()=>{var S,_,k,$,m,v,h;const o=(S=document.getElementById("mi-name"))==null?void 0:S.value.trim(),i=(_=document.getElementById("mi-price"))==null?void 0:_.value,d=parseFloat(i)||0,l=Math.max(1,parseInt((k=document.getElementById("mi-qty"))==null?void 0:k.value)||1),r=(($=document.getElementById("mi-unit"))==null?void 0:$.value.trim())||"pcs",c=((m=document.getElementById("mi-category"))==null?void 0:m.value)||"Lainnya",y=((v=document.getElementById("mi-emoji"))==null?void 0:v.value)||"🏷️",x=(h=document.getElementById("mi-save-catalog"))==null?void 0:h.checked;if(!o){window.showToast("Nama produk wajib diisi!","warning");return}if(i===""||d<0){window.showToast("Harga tidak boleh kosong atau negatif!","warning");return}try{if(x){const w=await Tt({name:o,price:d,unit:r,category:c,emoji:y,stock:999}),b=await z();g.setProducts(b);const u=b.find(T=>T.id===w)||{id:w,name:o,price:d,unit:r,category:c,emoji:y};g.addToCart(u,l),window.showToast(`Product "${o}" ditambahkan ke katalog & keranjang`,"success")}else{const w={id:"manual_"+Date.now()+"_"+Math.random().toString(36).slice(2,6),name:o,price:d,unit:r,category:c,emoji:y};g.addToCart(w,l),window.showToast(`"${o}" ditambahkan ke keranjang`,"success")}P("manual-item-modal")}catch(w){window.showToast("Gagal menambahkan item manual!","error"),console.error("[manual-item]",w)}})},0)},ie=t=>{document.addEventListener("click",e=>{const s=e.target.closest(".cat-pill");if(s){Q=s.dataset.cat,ut(),F();return}if(e.target.closest("#btn-manual-item")){se();return}if(e.target.closest("#btn-pay-cash")){if(!g.state.cart.length){window.showToast("Keranjang kosong!","warning");return}at("cash")}if(e.target.closest("#btn-pay-transfer")){if(!g.state.cart.length){window.showToast("Keranjang kosong!","warning");return}at("transfer")}if(e.target.closest("#btn-pay-debt")){if(!g.state.cart.length){window.showToast("Keranjang kosong!","warning");return}at("debt")}e.target.closest("#btn-clear-cart")&&g.state.cart.length&&(g.clearCart(),window.showToast("Keranjang dikosongkan","info"))},{signal:t}),document.addEventListener("input",e=>{e.target.id==="pos-search"&&(dt=e.target.value.trim(),F()),e.target.id==="discount-input"&&g.setDiscount(parseFloat(e.target.value)||0),e.target.id==="customer-name"&&g.setCustomerName(e.target.value)},{signal:t})},oe=async()=>{const t=document.getElementById("view-pos");(!t||!t.querySelector(".pos-layout"))&&Bt();const e=await z();g.setProducts(e),F(),ut()},ht=["💧","🪣","🍶","🥤","💦","🛵","🚚","⚗️","📦","🏷️","🫙","🧊"],re=["Galon","Botol","Layanan","Lainnya"],de=async()=>{await tt()},tt=async()=>{const t=document.getElementById("view-products"),e=await z();t.innerHTML=`
    ...
    <div class="products-grid" id="products-grid">
      ${e.length?e.map(s=>le(s)).join(""):`<div class="empty-state" style="grid-column:1/-1">
            <div class="empty-state__icon">📦</div>
...
`,ce=()=>{const t=document.getElementById("products-grid"),e=document.getElementById("btn-add-product");e==null||e.addEventListener("click",()=>wt()),t==null||t.addEventListener("click",async s=>{const n=s.target.closest('[data-action="edit"]'),a=s.target.closest('[data-action="delete"]');if(n){const o=parseInt(n.dataset.id),d=(await z()).find(l=>l.id===o);d&&wt(d)}if(a){const o=parseInt(a.dataset.id);pe(o)}})},wt=(t=null)=>{const e=!!t,s=`
    <div class="modal-header">
    ...
    <div class="modal-body">
      ...
      <div class="input-group">
        ...
        <select class="input" id="pf-category">
          ${re.map(n=>`<option value="${f(n)}" ${(t==null?void 0:t.category)===n?"selected":""}>${f(n)}</option>`).join("")}
        </select>
      </div>
      <div class="input-group">
        <label class="input-label">Emoji Ikon</label>
  ...
  `;L(s,"product-form"),setTimeout(()=>{var n,a,o;(n=document.getElementById("pf-close"))==null||n.addEventListener("click",()=>P("product-form")),(a=document.getElementById("pf-cancel"))==null||a.addEventListener("click",()=>P("product-form")),document.querySelectorAll(".emoji-pick").forEach(i=>{i.addEventListener("click",()=>{document.querySelectorAll(".emoji-pick").forEach(d=>{d.style.borderColor="var(--border-subtle)",d.classList.remove("emoji-pick--active")}),i.style.borderColor="var(--blue-400)",i.classList.add("emoji-pick--active"),document.getElementById("pf-emoji").value=i.dataset.emoji})}),(o=document.getElementById("pf-save"))==null||o.addEventListener("click",async()=>{var x,S,_,k,$,m;const i=(x=document.getElementById("pf-name"))==null?void 0:x.value.trim(),d=parseFloat((S=document.getElementById("pf-price"))==null?void 0:S.value)||0,l=((_=document.getElementById("pf-unit"))==null?void 0:_.value.trim())||"pcs",r=((k=document.getElementById("pf-category"))==null?void 0:k.value)||"Lainnya",c=(($=document.getElementById("pf-emoji"))==null?void 0:$.value)||"📦",y=parseInt((m=document.getElementById("pf-stock"))==null?void 0:m.value)||0;if(!i){window.showToast("Nama produk wajib diisi!","warning");return}if(d<=0){window.showToast("Harga harus lebih dari 0!","warning");return}try{e?(await Rt({...t,name:i,price:d,unit:l,category:r,emoji:c,stock:y}),window.showToast("Produk berhasil diperbarui","success")):(await Tt({name:i,price:d,unit:l,category:r,emoji:c,stock:y}),window.showToast("Produk berhasil ditambahkan","success")),P("product-form");const v=await z();g.setProducts(v),await tt()}catch(v){window.showToast("Gagal menyimpan produk!","error"),console.error("[products]",v)}})},0)},pe=t=>{L(`
    <div class="modal-header">
  ...
  `,"delete-confirm"),setTimeout(()=>{var s,n,a;(s=document.getElementById("dc-close"))==null||s.addEventListener("click",()=>P("delete-confirm")),(n=document.getElementById("dc-cancel"))==null||n.addEventListener("click",()=>P("delete-confirm")),(a=document.getElementById("dc-confirm"))==null||a.addEventListener("click",async()=>{try{await Kt(t);const o=await z();g.setProducts(o),P("delete-confirm"),await tt(),window.showToast("Produk dihapus","success")}catch(o){window.showToast("Gagal menghapus produk","error"),console.error("[products]",o)}})},0)};let nt=null;const ue=async()=>{nt&&nt(),nt=g.on("transactions:change",t=>{zt(t)}),await At()},At=async()=>{const t=await X();g.setTransactions(t),zt(t)},Mt=t=>{const e=t.paymentMethod,s=t.paymentStatus;return e==="transfer"&&s==="transfer_pending"?'<span class="badge" style="background:#fef3c7;color:#92400e;border:1px solid #fcd34d">⏳ Pending</span>':e==="transfer"&&s==="transfer_confirmed"?'<span class="badge badge--green">✅ Confirmed</span>':s==="unpaid"?'<span class="badge" style="background:#fee2e2;color:#991b1b;border:1px solid #fca5a5">🔴 Belum Lunas</span>':s==="partial"?'<span class="badge" style="background:#fef3c7;color:#92400e;border:1px solid #fcd34d">🟡 Cicilan</span>':'<span class="badge badge--green">✅ Lunas</span>'},Nt=t=>t.paymentMethod==="cash"?"💵 Tunai":t.paymentMethod==="transfer"?"📲 Transfer":t.paymentMethod==="debt"?"📋 Hutang":f(t.paymentMethod)||"—",j=t=>!(t.paymentMethod==="debt"&&(t.remainingDebt||0)>0),zt=t=>{const e=document.getElementById("view-transactions");if(!e)return;const s=[...t].sort((l,r)=>new Date(r.date)-new Date(l.date)),n=new Date().toISOString().split("T")[0],o=t.filter(l=>l.dateKey===n).reduce((l,r)=>r.paymentStatus==="paid"&&r.paymentMethod==="cash"||r.paymentStatus==="transfer_confirmed"?l+r.total:r.paymentMethod==="debt"?l+(r.paidAmount||0):l,0),i=t.reduce((l,r)=>l+(r.remainingDebt||0),0),d=t.filter(l=>l.paymentStatus==="transfer_pending").reduce((l,r)=>l+r.total,0);e.innerHTML=`
    ...
    `}
  `,me(t,s)},lt=t=>t.length?t.map(e=>{var s;return`
    <tr>
  ...
  `}).join(""):'<tr><td colspan="8" style="text-align:center;color:var(--text-muted);padding:32px;font-size:13px">Tidak ada transaksi untuk filter ini</td></tr>',me=(t,e)=>{var s,n,a;(s=document.getElementById("tx-filter-date"))==null||s.addEventListener("change",o=>{const i=o.target.value,d=i?[...t].filter(r=>r.dateKey===i).sort((r,c)=>new Date(c.date)-new Date(r.date)):e,l=document.getElementById("tx-tbody");l&&(l.innerHTML=lt(d))}),(n=document.getElementById("tx-clear-filter"))==null||n.addEventListener("click",()=>{const o=document.getElementById("tx-tbody"),i=document.getElementById("tx-filter-date");o&&(o.innerHTML=lt(e)),i&&(i.value="")}),(a=document.getElementById("tx-table"))==null||a.addEventListener("click",async o=>{const i=o.target.closest("[data-action]");if(!i)return;const d=parseInt(i.dataset.id),l=i.dataset.action,r=t.find(c=>c.id===d);if(l==="detail"){r&&ve(r);return}if(l==="confirm-transfer"){if(!r||!confirm(`Konfirmasi transfer ${p(r.total)} dari ${f(r.customerName||"pelanggan")} sudah diterima?`))return;try{const c={...r,paymentStatus:"transfer_confirmed",paidAmount:r.total,confirmedAt:new Date().toISOString()};await Y(c),g.updateTransaction(d,{paymentStatus:"transfer_confirmed",paidAmount:r.total,confirmedAt:c.confirmedAt}),window.showToast("Transfer dikonfirmasi! Kas bertambah.","success")}catch(c){console.error("[tx]",c),window.showToast("Gagal konfirmasi","error")}return}if(l==="pay-debt"){r&&ge(r);return}if(l==="delete"){if(!r)return;if(!j(r)){window.showToast("Tidak bisa hapus transaksi yang masih ada sisa hutang!","error");return}if(!confirm(`Hapus transaksi ${f(r.invoiceNo)}? Tindakan tidak bisa dibatalkan.`))return;try{await Ht(d),g.removeTransaction(d),window.showToast("Transaksi dihapus","success")}catch(c){console.error("[tx]",c),window.showToast("Gagal menghapus","error")}}})},ge=t=>{var n;const e=t.remainingDebt||0,s=`
    <div class="modal-header">
  ...
  `;L(s,"debt-modal"),setTimeout(()=>{var a,o,i;(a=document.getElementById("debt-x"))==null||a.addEventListener("click",()=>P("debt-modal")),(o=document.getElementById("debt-cancel"))==null||o.addEventListener("click",()=>P("debt-modal")),(i=document.getElementById("debt-save"))==null||i.addEventListener("click",async()=>{var $,m,v;const d=parseFloat(($=document.getElementById("cicil-amount"))==null?void 0:$.value)||0;if(d<=0||d>e){window.showToast(`Jumlah cicilan harus antara 1 dan ${p(e)}`,"warning");return}const l=(t.paidAmount||0)+d,r=Math.max(0,e-d),c=r===0?"paid":"partial",y=(t.debtPayments||[]).length+1,x=r===0?`Pelunasan (#${y}/LUNAS ✅)`:`Cicilan #${y}`,S=((v=(m=document.getElementById("cicil-note"))==null?void 0:m.value)==null?void 0:v.trim())||x,_=[...t.debtPayments||[],{date:new Date().toISOString(),amount:d,note:S}],k={...t,paidAmount:l,remainingDebt:r,paymentStatus:c,debtPayments:_};try{await Y(k),g.updateTransaction(t.id,{paidAmount:l,remainingDebt:r,paymentStatus:c,debtPayments:_}),P("debt-modal"),window.showToast(r===0?"🎉 Hutang LUNAS!":`Cicilan ${p(d)} dicatat`,"success")}catch(h){console.error("[debt]",h),window.showToast("Gagal simpan cicilan","error")}})},0)},ve=t=>{const e=pt(t,g.state.settings);sessionStorage.setItem("pendingReceipt",JSON.stringify(e));const s=Pt(t),n=g.state.settings.printEnabled,a=`
    <div class="modal-header">
  ...
  `;L(a,"tx-detail"),setTimeout(()=>{var o,i,d,l;(o=document.getElementById("td-x"))==null||o.addEventListener("click",()=>P("tx-detail")),(i=document.getElementById("td-close-btn"))==null||i.addEventListener("click",()=>P("tx-detail")),(d=document.getElementById("btn-save-png"))==null||d.addEventListener("click",async()=>{var c;const r=document.getElementById("btn-save-png");r.textContent="⏳...",r.disabled=!0;try{const{default:y}=await V(async()=>{const{default:$}=await import("./vendor-pdf-j4-ZKoBl.js").then(m=>m.h);return{default:$}},[],import.meta.url),x=document.getElementById("receipt-capture"),S=await y(x,{backgroundColor:"#fff",scale:2,useCORS:!0,logging:!1}),_=await new Promise($=>S.toBlob($,"image/png")),k=`Struk-${t.invoiceNo||t.id}.png`;if((c=navigator.canShare)!=null&&c.call(navigator,{files:[new File([_],k,{type:"image/png"})]}))await navigator.share({title:`Struk ${t.invoiceNo}`,files:[new File([_],k,{type:"image/png"})]});else{const $=URL.createObjectURL(_);Object.assign(document.createElement("a"),{href:$,download:k}).click(),setTimeout(()=>URL.revokeObjectURL($),2e3),window.showToast("PNG tersimpan!","success")}}catch(y){console.error("[png]",y),window.showToast("Gagal buat PNG","error")}finally{r.textContent="🖼️ PNG",r.disabled=!1}}),(l=document.getElementById("btn-save-pdf"))==null||l.addEventListener("click",()=>{const r=document.getElementById("receipt-capture");if(!r)return;const c=window.open("","_blank","width=400,height=700");if(!c){window.showToast("Popup diblokir browser. Ijinkan popup.","warning");return}c.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Struk ${f(t.invoiceNo||"")}</title>
      ...
      </head><body>${r.innerHTML}<script>window.onload=function(){window.print();window.onafterprint=function(){window.close()}}<\/script></body></html>`),c.document.close()})},0)};let st=null,J=null,W=null,D="semua";const be=async()=>{st&&st(),st=g.on("transactions:change",t=>{gt(t)}),await mt()},mt=async()=>{const t=await X();g.setTransactions(t),gt(t)},gt=t=>{var h,w;const e=document.getElementById("view-reports");if(!e)return;const s=U(),n=Xt(),a=t.filter(b=>b.dateKey===s),o=a.reduce((b,u)=>b+u.total,0),i=a.length,d=t.filter(b=>{var u;return(u=b.dateKey)==null?void 0:u.startsWith(n)}),l=d.reduce((b,u)=>b+u.total,0),r=t.reduce((b,u)=>b+u.total,0),c=a.filter(b=>b.paymentMethod==="cash").reduce((b,u)=>b+u.total,0),y=a.filter(b=>b.paymentMethod==="transfer"&&b.paymentStatus==="transfer_confirmed").reduce((b,u)=>b+u.total,0),x=a.filter(b=>b.paymentMethod==="transfer"&&b.paymentStatus==="transfer_pending").reduce((b,u)=>b+u.total,0),S=a.filter(b=>b.paymentMethod==="debt").reduce((b,u)=>b+u.total,0),_=t.reduce((b,u)=>{for(const T of u.debtPayments||[])T.date&&T.date.split("T")[0]===s&&(b+=T.amount||0);return b},0),k=c+y+_,$=t.reduce((b,u)=>b+(u.remainingDebt||0),0);t.filter(b=>b.paymentStatus==="transfer_pending").reduce((b,u)=>b+u.total,0);const m=xe(a),v=we(t);J&&(J.destroy(),J=null),W&&(W.destroy(),W=null),e.innerHTML=`
    <div class="section-header">
      <div>
      ...
      <div class="card">
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <strong style="color:#2563eb">${p(y)}</strong>
          </div>
        ...
        <div style="margin-top:16px;display:flex;align-items:center;justify-content:center;height:140px">
          ${c+y+S+_>0?'<canvas id="chart-donut" width="140" height="140"></canvas>':'<div style="color:var(--text-muted);font-size:12px;text-align:center">Belum ada transaksi hari ini</div>'}
        </div>
      </div>
  ...
  `,(h=document.getElementById("btn-refresh-reports"))==null||h.addEventListener("click",mt),(w=document.getElementById("btn-export-pdf-report"))==null||w.addEventListener("click",()=>he(t,s,n)),document.querySelectorAll("[data-rpt-filter]").forEach(b=>{b.addEventListener("click",()=>{D=b.dataset.rptFilter,gt(t)})}),requestAnimationFrame(()=>fe(v,c,y,S,_))},ye=(t,e)=>{let s=[...t];e==="cash"&&(s=s.filter(a=>a.paymentMethod==="cash")),e==="transfer"&&(s=s.filter(a=>a.paymentMethod==="transfer")),e==="debt"&&(s=s.filter(a=>a.paymentMethod==="debt"));const n=s.sort((a,o)=>new Date(o.date)-new Date(a.date));return n.length?n.slice(0,50).map(a=>{const o=a.total||0;let i=0,d=0;a.paymentMethod==="cash"?i=o:a.paymentMethod==="transfer"?a.paymentStatus==="transfer_confirmed"?i=o:d=o:a.paymentMethod==="debt"&&(i=a.paidAmount||0,d=a.remainingDebt||0);const l=(a.items||[]).map(y=>{var x;return`${((x=y.product)==null?void 0:x.name)||"Item"} (${y.qty}x)`}).join(", "),r=a.paymentMethod==="debt"?d===0?'<span class="badge badge--green">✅ LUNAS</span>':`<span class="badge" style="background:#fee2e2;color:#991b1b">🔴 Sisa ${p(d)}</span>`:a.paymentStatus==="transfer_pending"?'<span class="badge" style="background:#fef3c7;color:#92400e">⏳ Pending</span>':'<span class="badge badge--green">✅ Lunas</span>',c=a.paymentMethod==="cash"?"💵 Tunai":a.paymentMethod==="transfer"?"📲 Transfer":"📋 Hutang";return`
      <tr>
        ...
        <td style="font-size:11px;color:var(--text-secondary);max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="${f(l)}">${f(l||"—")}</td>
        ...
        <td style="white-space:nowrap"><span class="badge badge--blue" style="margin-right:4px">${c}</span> ${r}</td>
      </tr>
    `}).join(""):'<tr><td colspan="8" style="text-align:center;padding:30px;color:var(--text-muted)">Tidak ada transaksi untuk filter ini</td></tr>'},fe=async(t,e,s,n,a)=>{const{Chart:o,registerables:i}=await V(async()=>{const{Chart:c,registerables:y}=await import("./vendor-chart-19k6OvwP.js");return{Chart:c,registerables:y}},[],import.meta.url);o.register(...i);const d=document.getElementById("chart-bar");d&&(J=new o(d,{type:"bar",data:{labels:t.map(c=>c.label),datasets:[{label:"Omzet Harian (Rp)",data:t.map(c=>c.total),backgroundColor:t.map((c,y)=>y===6?"rgba(37,99,235,0.85)":"rgba(37,99,235,0.35)"),borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:c=>" "+p(c.raw)}}},scales:{y:{beginAtZero:!0,ticks:{callback:c=>p(c),font:{size:10},maxTicksLimit:5},grid:{color:"rgba(37,99,235,0.06)"}},x:{ticks:{font:{size:11}},grid:{display:!1}}}}}));const l=document.getElementById("chart-donut"),r=e+s+n+a;l&&r>0&&(W=new o(l,{type:"doughnut",data:{labels:["Tunai","Transfer","Piutang Baru","Cicilan Masuk"],datasets:[{data:[e,s,n,a],backgroundColor:["#10b981","#3b82f6","#ef4444","#8b5cf6"],borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!1,cutout:"65%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:c=>` ${c.label}: ${p(c.raw)}`}}}}}))},he=async(t,e,s)=>{try{const n=document.getElementById("btn-export-pdf-report");n&&(n.textContent="⏳ Memproses PDF...",n.disabled=!0);const{jsPDF:a}=await V(async()=>{const{jsPDF:u}=await import("./vendor-pdf-j4-ZKoBl.js").then(T=>T.j);return{jsPDF:u}},[],import.meta.url),{default:o}=await V(async()=>{const{default:u}=await import("./jspdf.plugin.autotable-QkGqYg11.js").then(T=>T.j);return{default:u}},__vite__mapDeps([0,1,2]),import.meta.url),i=new a({orientation:"portrait",unit:"mm",format:"a4"}),d=g.state.settings,l=i.internal.pageSize.getWidth();i.setFontSize(16),i.setFont("helvetica","bold"),i.text(d.shopName||"Blue Mountain Refilling Station",l/2,16,{align:"center"}),i.setFontSize(10),i.setFont("helvetica","normal"),i.text("LAPORAN PENJUALAN & ANALISIS KEUANGAN LENGKAP",l/2,22,{align:"center"}),i.text(`Dicetak: ${new Date().toLocaleDateString("id-ID",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}`,l/2,27,{align:"center"});const r=t.filter(u=>u.dateKey===e),c=r.reduce((u,T)=>u+T.total,0),y=t.filter(u=>{var T;return(T=u.dateKey)==null?void 0:T.startsWith(s)}).reduce((u,T)=>u+T.total,0),x=t.reduce((u,T)=>u+T.total,0),S=r.filter(u=>u.paymentMethod==="cash").reduce((u,T)=>u+T.total,0),_=r.filter(u=>u.paymentMethod==="transfer"&&u.paymentStatus==="transfer_confirmed").reduce((u,T)=>u+T.total,0),k=t.reduce((u,T)=>{for(const B of T.debtPayments||[])B.date&&B.date.split("T")[0]===e&&(u+=B.amount||0);return u},0),$=S+_+k,m=t.reduce((u,T)=>u+(T.remainingDebt||0),0);i.setFontSize(11),i.setFont("helvetica","bold"),i.text("1. Ringkasan Kinerja Keuangan",14,35);const v=[["Omzet Gross Hari Ini",p(c)],["Kas Masuk Real Hari Ini (Tunai+TF+Cicilan)",p($)],["Cicilan Piutang Terkumpul Hari Ini",p(k)],["Total Piutang Belum Lunas (Semua Pelanggan)",p(m)],["Omzet Bulan Ini",p(y)],["Total Omzet All-Time",p(x)],["Jumlah Transaksi Hari Ini",`${r.length} transaksi`]];o(i,{startY:38,head:[["Indikator Keuangan","Nilai (Rp)"]],body:v,theme:"grid",headStyles:{fillColor:[30,58,138],textColor:255,fontStyle:"bold"},columnStyles:{1:{halign:"right",fontStyle:"bold"}},margin:{left:14,right:14}});const h=i.lastAutoTable.finalY+10;i.setFontSize(11),i.setFont("helvetica","bold"),i.text("2. Rincian Riwayat Transaksi & Pelunasan",14,h);const w=[...t].sort((u,T)=>new Date(T.date)-new Date(u.date)).slice(0,80);o(i,{startY:h+4,head:[["Invoice","Tanggal","Pelanggan","Metode","Total Tagihan","Terbayar","Sisa Piutang","Status"]],body:w.map(u=>{let T=u.paymentMethod==="cash"?u.total:u.paymentMethod==="transfer"?u.paymentStatus==="transfer_confirmed"?u.total:0:u.paidAmount||0,B=u.paymentMethod==="debt"?u.remainingDebt||0:u.paymentStatus==="transfer_pending"?u.total:0;return[u.invoiceNo||"-",new Date(u.date).toLocaleDateString("id-ID"),u.customerName||"—",u.paymentMethod==="cash"?"Tunai":u.paymentMethod==="transfer"?"Transfer":"Hutang",p(u.total),p(T),B>0?p(B):"—",u.paymentMethod==="debt"?B===0?"Lunas":"Cicilan":u.paymentStatus==="transfer_pending"?"Pending":"Lunas"]}),theme:"striped",headStyles:{fillColor:[30,58,138],textColor:255,fontStyle:"bold",fontSize:8},bodyStyles:{fontSize:8},columnStyles:{4:{halign:"right"},5:{halign:"right"},6:{halign:"right"}},margin:{left:14,right:14}});const b=i.internal.getNumberOfPages();for(let u=1;u<=b;u++)i.setPage(u),i.setFontSize(8),i.setFont("helvetica","normal"),i.text(`Hal ${u} dari ${b} — ${d.shopName||"Blue Mountain POS"}`,l/2,i.internal.pageSize.getHeight()-8,{align:"center"});i.save(`Laporan-Keuangan-${e}.pdf`),window.showToast("Laporan PDF berhasil diekspor!","success")}catch(n){console.error("[pdf-report]",n),window.showToast("Gagal export PDF","error")}finally{const n=document.getElementById("btn-export-pdf-report");n&&(n.textContent="📄 Export PDF Laporan",n.disabled=!1)}},we=t=>{const e=[];for(let s=6;s>=0;s--){const n=new Date;n.setDate(n.getDate()-s);const a=n.toISOString().split("T")[0],o=t.filter(d=>d.dateKey===a).reduce((d,l)=>d+l.total,0),i=new Intl.DateTimeFormat("id-ID",{weekday:"short"}).format(n);e.push({key:a,label:i,total:o})}return e},xe=t=>{var s;const e={};for(const n of t)for(const a of n.items||[]){if(!((s=a==null?void 0:a.product)!=null&&s.name))continue;const o=a.product.name;e[o]=(e[o]||0)+a.qty}return Object.entries(e).map(([n,a])=>({name:n,qty:a})).sort((n,a)=>a.qty-n.qty)},ke=async()=>{await $e(),await vt()},$e=async()=>{const t=["shopName","shopAddress","shopPhone","cashierName","printerUrl","printEnabled","taxRate","bankName","bankNumber","bankHolder","qrisNumber"],e={};for(const s of t){const n=await ct(s);n!==null&&(e[s]=n)}g.updateSettings(e)},vt=async()=>{const t=document.getElementById("view-settings"),e=g.state.settings,s="3.0.0",n=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0;t.innerHTML=`
    <div class="section-header">
  ...
  `,Te()},Te=()=>{var t,e,s,n,a,o,i,d;(t=document.getElementById("btn-export-backup"))==null||t.addEventListener("click",async()=>{var r;const l=document.getElementById("btn-export-backup");l&&(l.textContent="⏳ Menyiapkan...",l.disabled=!0);try{const c=await Jt(),y=JSON.stringify(c,null,2),x=new Blob([y],{type:"application/json"}),S=new Date().toISOString().replace(/[-:T]/g,"").slice(0,14),k=`Backup-KASIR-${(c.shopName||"KASIR").replace(/[^a-zA-Z0-9]/g,"_")}-${S}.json`;if((r=navigator.canShare)!=null&&r.call(navigator,{files:[new File([x],k,{type:"application/json"})]}))await navigator.share({title:"Backup KASIR",files:[new File([x],k,{type:"application/json"})]});else{const $=URL.createObjectURL(x),m=document.createElement("a");m.href=$,m.download=k,m.click(),setTimeout(()=>URL.revokeObjectURL($),2e3)}window.showToast("✅ File backup berhasil diunduh!","success")}catch(c){console.error("[export-backup]",c),window.showToast("Gagal ekspor backup","error")}finally{l&&(l.textContent="📥 Unduh Backup JSON",l.disabled=!1)}}),(e=document.getElementById("btn-trigger-import"))==null||e.addEventListener("click",()=>{var l;(l=document.getElementById("input-import-backup"))==null||l.click()}),(s=document.getElementById("input-import-backup"))==null||s.addEventListener("change",l=>{var y;const r=(y=l.target.files)==null?void 0:y[0];if(!r)return;const c=new FileReader;c.onload=async x=>{var S;try{const _=(S=x.target)==null?void 0:S.result,k=JSON.parse(_);if(!k.data||!k.data.products&&!k.data.transactions){window.showToast("Format file backup tidak valid!","error");return}const $=(k.data.products||[]).length,m=(k.data.transactions||[]).length,v=(k.data.expenses||[]).length,h=k.exportedAt?new Date(k.exportedAt).toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}):"Tidak diketahui",w=`
          <div class="modal-header">
        ...
        `;L(w,"import-confirm-modal"),setTimeout(()=>{var b,u,T;(b=document.getElementById("imp-x"))==null||b.addEventListener("click",()=>P("import-confirm-modal")),(u=document.getElementById("imp-cancel"))==null||u.addEventListener("click",()=>P("import-confirm-modal")),(T=document.getElementById("imp-confirm"))==null||T.addEventListener("click",async()=>{var N;const B=((N=document.querySelector('input[name="import-mode"]:checked'))==null?void 0:N.value)||"replace",M=document.getElementById("imp-confirm");M&&(M.textContent="⏳ Memulihkan...",M.disabled=!0);try{await Wt(k,B);const[A,I,K]=await Promise.all([z(),X(),_t()]);g.setProducts(A),g.setTransactions(I),g.setExpenses(K),P("import-confirm-modal"),window.showToast("🎉 Data berhasil dipulihkan & sinkron!","success"),setTimeout(()=>vt(),600)}catch(A){console.error("[import-backup]",A),window.showToast("Gagal memulihkan data: "+A.message,"error")}})},0)}catch(_){console.error("[parse-backup]",_),window.showToast("File JSON rusak atau tidak terbaca!","error")}},c.readAsText(r),l.target.value=""}),(n=document.getElementById("btn-save-settings"))==null||n.addEventListener("click",async()=>{const l=["shopName","shopAddress","shopPhone","cashierName","taxRate","bankName","bankNumber","bankHolder","printerUrl","qrisNumber"],r={};for(const y of l){const x=document.getElementById(`set-${y}`);x&&(r[y]=y==="taxRate"?parseFloat(x.value)||0:x.value.trim(),await rt(y,r[y]))}const c=document.getElementById("set-printEnabled");c&&(r.printEnabled=c.checked,await rt("printEnabled",c.checked)),g.updateSettings(r),window.showToast("Pengaturan berhasil disimpan","success")}),(a=document.getElementById("btn-printer-guide"))==null||a.addEventListener("click",()=>{_e()}),(o=document.getElementById("btn-install-pwa"))==null||o.addEventListener("click",()=>{window._pwaPrompt?window._pwaPrompt.prompt():window.showToast("Buka di Chrome / Edge untuk meng-install aplikasi ini","info")}),(i=document.getElementById("btn-clear-cache"))==null||i.addEventListener("click",async()=>{try{if("caches"in window){const l=await caches.keys();await Promise.all(l.map(r=>caches.delete(r)))}if("serviceWorker"in navigator){const l=await navigator.serviceWorker.getRegistrations();for(const r of l)await r.unregister()}window.showToast("Cache dihapus. Memperbarui...","success"),setTimeout(()=>window.location.reload(),1e3)}catch(l){console.error("[cache]",l),window.showToast("Gagal hapus cache","error")}}),(d=document.getElementById("btn-reset-all"))==null||d.addEventListener("click",async()=>{if(confirm(`⚠️ HAPUS SEMUA DATA?

Semua transaksi, pengeluaran, dan produk akan dihapus permanen.
Tindakan ini TIDAK dapat dibatalkan!`))try{await Ut(),window.showToast("Semua data berhasil dihapus. Reloading...","error"),setTimeout(()=>window.location.reload(),1500)}catch(r){console.error("[reset]",r),window.showToast("Gagal menghapus data","error")}})},_e=()=>{L(`
    <div class="modal-header">
  ...
  `,"printer-guide"),setTimeout(()=>{var e,s;(e=document.getElementById("pg-close"))==null||e.addEventListener("click",()=>P("printer-guide")),(s=document.getElementById("pg-close2"))==null||s.addEventListener("click",()=>P("printer-guide"))},0)};let it=null,ot=null,H=!1;const Ee=async()=>{it&&it(),ot&&ot(),it=g.on("transactions:change",()=>{H||R()}),ot=g.on("expenses:change",()=>{H||R()}),await R()},R=async()=>{if(!H){H=!0;try{const t=document.getElementById("view-finance");if(!t)return;const[e,s,n]=await Promise.all([g.state.transactions.length?Promise.resolve(g.state.transactions):X().then(m=>(g.setTransactions(m),m)),_t().then(m=>(g.setExpenses(m),m)),ct("modalAwal")]),a=parseFloat(n)||0;let o=0,i=0,d=0,l=0,r=0;for(const m of e)if(m.paymentMethod==="cash"&&(m.paymentStatus==="paid"||!m.paymentStatus)&&(o+=m.total),m.paymentMethod==="transfer"&&(m.paymentStatus==="transfer_confirmed"?i+=m.total:l+=m.total),m.paymentMethod==="debt"){for(const v of m.debtPayments||[])d+=v.amount;r+=m.remainingDebt||0}const c=o+i+d,y=s.reduce((m,v)=>m+(v.amount||0),0),x=a+c-y,S=l+r,_=Se(e,s),k=Ie(e,s),$=[...e.filter(m=>m.paymentStatus==="transfer_pending"),...e.filter(m=>(m.paymentMethod==="debt"||m.paymentStatus==="partial"||m.paymentStatus==="unpaid")&&(m.remainingDebt||0)>0)].sort((m,v)=>new Date(m.date)-new Date(v.date));t.innerHTML=`
      <div class="section-header">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;margin-bottom:20px">
        ...
        <div class="stat-card" style="border-left:4px solid #dc2626">
          <span class="stat-card__icon">📤</span>
          <div class="stat-card__value" style="color:#dc2626">${p(y)}</div>
      ...
      <div class="card" style="margin-bottom:16px">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px">
          ...
          ${O("⏳ Transfer Pending",l,"#d97706",!0)}
          ${O("🔴 Piutang Hutang",r,"#dc2626",!0)}
        </div>
      </div>
      ...
      <div class="card" style="margin-bottom:16px">
        ...
        <div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
          <table class="data-table" id="piutang-table">
            ...
            <tbody>
              ${$.map(m=>{const v=m.total||0,h=m.paymentStatus==="transfer_pending"?v:m.remainingDebt||0,w=v-h,b=Math.min(100,Math.max(0,Math.round(w/v*100))),u=(m.debtPayments||[]).length;return`
              <tr>
...
`,Se=(t,e)=>{const s={};for(const a of t){const o=a.dateKey;if(o){if(s[o]||(s[o]={masuk:0,keluar:0}),a.paymentMethod==="cash"&&(a.paymentStatus==="paid"||!a.paymentStatus)&&(s[o].masuk+=a.total),a.paymentMethod==="transfer"&&a.paymentStatus==="transfer_confirmed"){const i=a.confirmedAt?a.confirmedAt.split("T")[0]:o;s[i]||(s[i]={masuk:0,keluar:0}),s[i].masuk+=a.total}if(a.paymentMethod==="debt")for(const i of a.debtPayments||[]){const d=i.date?i.date.split("T")[0]:o;s[d]||(s[d]={masuk:0,keluar:0}),s[d].masuk+=i.amount}}}for(const a of e){const o=a.dateKey||(a.date?a.date.split("T")[0]:null);o&&(s[o]||(s[o]={masuk:0,keluar:0}),s[o].keluar+=a.amount||0)}const n=[];for(let a=29;a>=0;a--){const o=new Date;o.setDate(o.getDate()-a);const i=o.toISOString().split("T")[0];n.push({key:i,...s[i]||{masuk:0,keluar:0}})}return n},Pe=(t,e)=>{let s=e;const n=t.filter(a=>a.masuk>0||a.keluar>0).map(a=>{const o=a.masuk-a.keluar;return s+=o,`
    <tr>
    ...
    </tr>`});return n.length?n.join(""):'<tr><td colspan="5" style="text-align:center;padding:20px;color:var(--text-muted)">Tidak ada transaksi 30 hari terakhir</td></tr>'},Ie=(t,e)=>{const s=[];for(const n of t){const a=f(n.customerName||"Pelanggan");if(n.paymentMethod==="cash")s.push({date:n.date,desc:`Penjualan Tunai — ${n.invoiceNo} (${a})`,debit:n.total,credit:n.total,account:"Kas / Penjualan",type:"kas"});else if(n.paymentMethod==="transfer")n.paymentStatus==="transfer_confirmed"?s.push({date:n.confirmedAt||n.date,desc:`Transfer Terkonfirmasi — ${n.invoiceNo} (${a})`,debit:n.total,credit:n.total,account:"Bank / Penjualan",type:"kas"}):s.push({date:n.date,desc:`Transfer Pending — ${n.invoiceNo} (${a}) [Menunggu Konfirmasi]`,debit:n.total,credit:n.total,account:"Piutang Transfer",type:"piutang"});else if(n.paymentMethod==="debt"){s.push({date:n.date,desc:`Penjualan Piutang Usaha — ${n.invoiceNo} (${a}) [Total Tagihan: ${p(n.total)}]`,debit:n.total,credit:n.total,account:"Piutang / Penjualan",type:"piutang"});const o=n.debtPayments||[];let i=0;o.forEach((d,l)=>{i+=d.amount||0;const r=Math.max(0,n.total-i),c=r===0,y=l+1,x=c?`Pelunasan (#${y}/LUNAS ✅)`:`Cicilan #${y} (dari ${o.length})`,S=d.note?` — ${f(d.note)}`:"";s.push({date:d.date,desc:`${x} — ${n.invoiceNo} (${a})${S} [Bayar: ${p(d.amount)} | Sisa: ${p(r)}]`,debit:d.amount,credit:d.amount,account:c?"Kas / Piutang (LUNAS ✅)":"Kas / Piutang Usaha",type:"kas"})})}}for(const n of e)s.push({date:n.date,desc:`Beban ${f(n.category||"Operasional")} — ${f(n.note||"Pengeluaran kas")}`,debit:n.amount,credit:n.amount,account:`Beban (${f(n.category||"Operasional")}) / Kas`,type:"beban"});return s.sort((n,a)=>new Date(a.date)-new Date(n.date))},Be=t=>{var e,s,n,a,o;(e=document.getElementById("btn-refresh-finance"))==null||e.addEventListener("click",R),(s=document.getElementById("btn-set-modal-awal"))==null||s.addEventListener("click",()=>{const d=`
    ...
    `;L(d,"modal-awal"),setTimeout(()=>{var l,r,c;(l=document.getElementById("ma-x"))==null||l.addEventListener("click",()=>P("modal-awal")),(r=document.getElementById("ma-cancel"))==null||r.addEventListener("click",()=>P("modal-awal")),(c=document.getElementById("ma-save"))==null||c.addEventListener("click",async()=>{var x;const y=parseFloat((x=document.getElementById("modal-awal-input"))==null?void 0:x.value)||0;await rt("modalAwal",y),g.updateSettings({modalAwal:y}),P("modal-awal"),window.showToast("Modal Awal disimpan!","success"),R()})},0)}),(n=document.getElementById("btn-add-expense"))==null||n.addEventListener("click",()=>{const d=`
      ...
      <div class="modal-body">
        <div class="input-group">
          ...
          <select class="input" id="exp-category">
            ${["Belanja Bahan","Operasional","Gaji/Upah","Listrik/Air","Transportasi","Peralatan","Lainnya"].map(l=>`<option value="${f(l)}">${f(l)}</option>`).join("")}
          </select>
        </div>
        <div class="input-group" style="margin-top:10px">
    ...
    `;L(d,"expense-modal"),setTimeout(()=>{var l,r,c;(l=document.getElementById("exp-x"))==null||l.addEventListener("click",()=>P("expense-modal")),(r=document.getElementById("exp-cancel"))==null||r.addEventListener("click",()=>P("expense-modal")),(c=document.getElementById("exp-save"))==null||c.addEventListener("click",async()=>{var $,m,v,h;const y=parseFloat(($=document.getElementById("exp-amount"))==null?void 0:$.value)||0,x=((m=document.getElementById("exp-category"))==null?void 0:m.value)||"Lainnya",S=((h=(v=document.getElementById("exp-note"))==null?void 0:v.value)==null?void 0:h.trim())||"";if(y<=0){window.showToast("Jumlah harus lebih dari 0!","warning");return}const _=new Date().toISOString(),k={date:_,dateKey:_.split("T")[0],category:x,note:S,amount:y};try{const w=await Ft(k);k.id=w,g.addExpense(k),P("expense-modal"),window.showToast("Pengeluaran dicatat!","success")}catch(w){console.error("[expense]",w),window.showToast("Gagal simpan pengeluaran","error")}})},0)}),(a=document.getElementById("expense-table"))==null||a.addEventListener("click",async i=>{const d=i.target.closest('[data-action="delete-expense"]');if(!d||!confirm("Hapus pengeluaran ini?"))return;const l=parseInt(d.dataset.id);try{await qt(l),g.removeExpense(l),window.showToast("Pengeluaran dihapus","success")}catch(r){console.error("[expense]",r),window.showToast("Gagal hapus","error")}}),(o=document.getElementById("piutang-table"))==null||o.addEventListener("click",async i=>{const d=i.target.closest("[data-action]");if(!d)return;const l=parseInt(d.dataset.id),r=d.dataset.action,c=(g.state.transactions||t).find(y=>y.id===l);if(c){if(r==="confirm-transfer"){if(!confirm(`Konfirmasi transfer ${p(c.total)} dari ${f(c.customerName||"pelanggan")} sudah diterima?`))return;const y={...c,paymentStatus:"transfer_confirmed",paidAmount:c.total,confirmedAt:new Date().toISOString()};try{await Y(y),g.updateTransaction(l,{paymentStatus:"transfer_confirmed",paidAmount:c.total,confirmedAt:y.confirmedAt}),window.showToast("Transfer dikonfirmasi! Kas bertambah.","success")}catch(x){console.error("[confirm]",x),window.showToast("Gagal konfirmasi","error")}}if(r==="pay-debt"){const y=c.remainingDebt||0,x=`
        ...
        <div class="modal-body">
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px">
            ...
            <div style="padding:10px;background:#fef3c7;border-radius:10px;text-align:center">
              ...
              <div style="font-size:16px;font-weight:900;color:#d97706">${p(y)}</div>
            </div>
          </div>
          <div class="input-group">
            <label class="input-label">💵 Jumlah Cicilan</label>
            <input type="number" class="input" id="mc-amount" value="${y}" min="1" max="${y}" step="1000" inputmode="numeric">
          </div>
          <div class="input-group" style="margin-top:10px">
