...
import{X as jt}from"./vendor-db-2jmnBxhj.js";import{_ as V}from"./vendor-pdf-j4-ZKoBl.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();const E=new jt("BlueMountainPOS");E.version(2).stores({products:"++id, category",transactions:"++id, dateKey, paymentStatus, paymentMethod",settings:"key",expenses:"++id, dateKey, category"});const C=()=>E.products.toArray(),Tt=t=>E.products.add(t),Rt=t=>E.products.put(t),Kt=t=>E.products.delete(t),Ot=t=>E.transactions.add(t),X=()=>E.transactions.toArray(),Ht=t=>E.transactions.delete(t),Y=t=>E.transactions.put(t),Ft=t=>E.expenses.add(t),_t=()=>E.expenses.toArray(),qt=t=>E.expenses.delete(t),ct=async t=>{const e=await E.settings.get(t);return(e==null?void 0:e.value)??null},rt=(t,e)=>E.settings.put({key:t,value:e}),Ut=async()=>{await E.products.count()>0||await E.products.bulkAdd([{name:"Air Isi Ulang Galon",category:"Galon",price:5e3,unit:"galon",emoji:"🪣",stock:999},{name:"Antar Galon (dalam)",category:"Galon",price:3e3,unit:"kali",emoji:"🛵",stock:999},{name:"Antar Galon (luar)",category:"Galon",price:5e3,unit:"kali",emoji:"🚚",stock:999},{name:"Galon Baru (Aqua)",category:"Galon",price:5e4,unit:"buah",emoji:"💧",stock:50},{name:"Galon Baru (Standar)",category:"Galon",price:45e3,unit:"buah",emoji:"💦",stock:50},{name:"Air Botol 600ml",category:"Botol",price:3e3,unit:"botol",emoji:"🍶",stock:200},{name:"Air Botol 1500ml",category:"Botol",price:5e3,unit:"botol",emoji:"🥤",stock:100},{name:"Dispenser Galon",category:"Lainnya",price:25e4,unit:"unit",emoji:"⚗️",stock:10}])},Gt=async()=>{await Promise.all([E.products.clear(),E.transactions.clear(),E.expenses.clear(),E.settings.clear()]),sessionStorage.clear(),localStorage.clear()},Jt=async()=>{const[t,e,s,n]=await Promise.all([E.products.toArray(),E.transactions.toArray(),E.expenses.toArray(),E.settings.toArray()]),a=n.find(i=>i.key==="shopName"),o=(a==null?void 0:a.value)||"Blue Mountain";return{app:"Blue Mountain POS",version:"3.0.0",exportedAt:new Date().toISOString(),shopName:o,data:{products:t,transactions:e,expenses:s,settings:n},meta:{productCount:t.length,transactionCount:e.length,expenseCount:s.length,settingCount:n.length}}},Wt=async(t,e="replace")=>{if(!t||!t.data)throw new Error("Format file backup tidak valid atau rusak.");const{products:s=[],transactions:n=[],expenses:a=[],settings:o=[]}=t.data;return e==="replace"?(await Promise.all([E.products.clear(),E.transactions.clear(),E.expenses.clear(),E.settings.clear()]),s.length&&await E.products.bulkAdd(s),n.length&&await E.transactions.bulkAdd(n),a.length&&await E.expenses.bulkAdd(a),o.length&&await E.settings.bulkPut(o)):e==="merge"&&(s.length&&await E.products.bulkPut(s),n.length&&await E.transactions.bulkPut(n),a.length&&await E.expenses.bulkPut(a),o.length&&await E.settings.bulkPut(o)),{products:s.length,transactions:n.length,expenses:a.length,settings:o.length}},Vt=()=>E.open(),z={},g={state:{cart:[],products:[],transactions:[],expenses:[],currentView:"pos",discount:0,customerName:"",settings:{shopName:"Blue Mountain Refilling Station",shopAddress:"Jl. Contoh No. 1, Kota",shopPhone:"0812-3456-7890",cashierName:"Admin",printerUrl:"",printEnabled:!1,taxRate:0,bankName:"BCA",bankNumber:"",bankHolder:"Blue Mountain Refilling Station",qrisNumber:"",modalAwal:0}},on(t,e){return(z[t]??(z[t]=[])).push(e),()=>{z[t]=(z[t]??[]).filter(s=>s!==e)}},emit(t,e){(z[t]??[]).forEach(s=>s(e))},addToCart(t,e=1){const s=Math.max(1,parseInt(e)||1),n=this.state.cart.findIndex(a=>String(a.product.id)===String(t.id));n>=0?this.state.cart[n].qty+=s:this.state.cart.push({product:t,qty:s}),this.emit("cart:change",this.state.cart)},removeFromCart(t){this.state.cart=this.state.cart.filter(e=>String(e.product.id)!==String(t)),this.emit("cart:change",this.state.cart)},setQty(t,e){if(e<=0)return this.removeFromCart(t);const s=this.state.cart.find(n=>String(n.product.id)===String(t));s&&(s.qty=e,this.emit("cart:change",this.state.cart))},clearCart(){this.state.cart=[],this.state.discount=0,this.state.customerName="",this.emit("cart:change",this.state.cart)},setDiscount(t){this.state.discount=Math.max(0,parseFloat(t)||0),this.emit("cart:change",this.state.cart)},setCustomerName(t){this.state.customerName=String(t??"").slice(0,80)},get subtotal(){return this.state.cart.reduce((t,e)=>t+e.product.price*e.qty,0)},get tax(){return Math.round(this.subtotal*(this.state.settings.taxRate||0)/100)},get total(){return Math.max(0,this.subtotal+this.tax-this.state.discount)},get cartCount(){return this.state.cart.reduce((t,e)=>t+e.qty,0)},setProducts(t){this.state.products=t,this.emit("products:change",t)},setTransactions(t){this.state.transactions=t,this.emit("transactions:change",t)},removeTransaction(t){this.state.transactions=this.state.transactions.filter(e=>e.id!==t),this.emit("transactions:change",this.state.transactions)},addTransaction(t){this.state.transactions=[t,...this.state.transactions],this.emit("transactions:change",this.state.transactions)},updateTransaction(t,e){const s=this.state.transactions.findIndex(n=>n.id===t);s>=0&&(this.state.transactions[s]={...this.state.transactions[s],...e},this.emit("transactions:change",this.state.transactions))},setExpenses(t){this.state.expenses=t,this.emit("expenses:change",t)},addExpense(t){this.state.expenses=[...this.state.expenses,t],this.emit("expenses:change",this.state.expenses)},removeExpense(t){this.state.expenses=this.state.expenses.filter(e=>e.id!==t),this.emit("expenses:change",this.state.expenses)},navigate(t){this.state.currentView=t,this.emit("navigate",t)},updateSettings(t){Object.assign(this.state.settings,t),this.emit("settings:change",this.state.settings)}},Yt=(t=new Date)=>new Intl.DateTimeFormat("id-ID",{weekday:"long",year:"numeric",month:"long",day:"numeric"}).format(t instanceof Date?t:new Date(t)),Qt=(t=new Date)=>new Intl.DateTimeFormat("id-ID",{year:"numeric",month:"2-digit",day:"2-digit"}).format(t instanceof Date?t:new Date(t)),Et=(t=new Date)=>new Intl.DateTimeFormat("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).format(t instanceof Date?t:new Date(t)),Z=(t=new Date)=>`${Qt(t)} ${Et(t)}`,G=()=>new Date().toISOString().split("T")[0],Xt=()=>{const t=new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`},p=t=>isNaN(t)?"Rp 0":"Rp "+Math.round(t).toLocaleString("id-ID"),f=t=>t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),pt=(t,e)=>{const s=t.items||[],n=[],a=(l,r=0,d=1,c=0)=>n.push({type:0,content:l,bold:r,align:d,format:c}),o=()=>a("--------------------------------",0,1,0),i=()=>a(" ",0,0,0);i(),a(e.shopName||"Blue Mountain Refilling Station",1,1,2),a(e.shopAddress||"",0,1,4),e.shopPhone&&a(`Telp: ${e.shopPhone}`,0,1,4),o(),a(`No: ${t.invoiceNo||"-"}`,0,0,0),a(`Tgl: ${Z(new Date(t.date))}`,0,0,0),t.customerName&&a(`Pelanggan: ${t.customerName}`,0,0,0),t.cashier&&a(`Kasir: ${t.cashier}`,0,0,0),o();for(const l of s){if(!(l!=null&&l.product))continue;const r=l.product.name,d=l.qty,c=p(l.product.price),b=p(l.product.price*d);a(`${r}`,0,0,0),a(`  ${d} x ${c} = ${b}`,0,0,0)}return o(),t.discount>0&&(a(`Subtotal: ${p(t.subtotal)}`,0,0,0),a(`Diskon:  -${p(t.discount)}`,0,0,0)),t.tax>0&&a(`Pajak:    ${p(t.tax)}`,0,0,0),a(`TOTAL: ${p(t.total)}`,1,0,3),t.paymentMethod==="cash"?(a(`Bayar:   ${p(t.paid)}`,0,0,0),a(`Kembali: ${p(t.change)}`,1,0,0)):t.paymentMethod==="transfer"?(a(`Transfer: ${p(t.total)}`,0,0,0),a(`Status: ${t.paymentStatus==="transfer_confirmed"?"TERKONFIRMASI":"MENUNGGU KONFIRMASI"}`,0,0,0)):t.paymentMethod==="debt"&&(a(`DP Dibayar: ${p(t.paidAmount||0)}`,0,0,0),a(`Sisa Hutang: ${p(t.remainingDebt||0)}`,1,0,0)),o(),i(),a("Terima kasih sudah berbelanja!",1,1,0),a(e.shopName||"Blue Mountain Refilling Station",0,1,4),i(),i(),n},Zt=""+new URL("logo-x8cg0OuI.png",import.meta.url).href,St=()=>{const t=window.location.pathname.replace(/\/[^/]*$/,"/");return`${window.location.origin}${t}receipt-data.html`},te=t=>{const e=pt(t,g.state.settings);return sessionStorage.setItem("pendingReceipt",JSON.stringify(e)),St()},Pt=t=>(te(t),`my.bluetoothprint.scheme://${g.state.settings.printerUrl||St()}`),It=t=>{const e=g.state.settings,s=t.items||[],n=(l,r=!1,d="left")=>`<div style="text-align:${d};font-weight:${r?"bold":"normal"}">${l}</div>`,a=()=>'<div style="border-top:1px dashed #bbb;margin:5px 0"></div>',o=()=>"<div>&nbsp;</div>";let i="";i+=`<div style="text-align:center;margin-bottom:8px;margin-top:4px">
    ...
    <div class="modal-body">
      ...
      <div id="pay-transfer-section" style="${t!=="transfer"?"display:none":""}">
        <div class="transfer-info">
          ...
          <div style="font-size:18px;font-weight:800;color:var(--text-primary);margin:6px 0">${i}: ${l}</div>
  ...
  `,document.body.appendChild(o);const i=()=>{o.classList.add("closing"),setTimeout(()=>o.remove(),180)};(l=document.getElementById("success-close-btn"))==null||l.addEventListener("click",i),(r=document.getElementById("btn-close-overlay"))==null||r.addEventListener("click",i),(d=document.getElementById("btn-new-tx"))==null||d.addEventListener("click",()=>{i(),window.showToast("Siap transaksi baru! 👍","success")}),setTimeout(()=>{o.parentNode&&i()},15e3)};let dt="",Q="Semua",U=null,ft=[];const ne=async()=>{const t=await C();g.setProducts(t),Bt(),U&&U.abort(),U=new AbortController,ft.forEach(e=>e()),ft=[g.on("cart:change",Lt),g.on("products:change",()=>F())],oe(U.signal)},Bt=()=>{const t=document.getElementById("view-pos");t.innerHTML=`
  ...
  `).join(""),t.querySelectorAll("[data-action]").forEach(r=>{r.addEventListener("click",()=>{const d=r.dataset.pid,c=r.dataset.action,b=g.state.cart.find(x=>String(x.product.id)===String(d));b&&(c==="inc"?g.setQty(b.product.id,b.qty+1):c==="dec"?g.setQty(b.product.id,b.qty-1):c==="remove"&&g.removeFromCart(b.product.id))})})},ie=()=>{const t=`
    <div class="modal-header">
...
`,pe=()=>{const t=document.getElementById("products-grid"),e=document.getElementById("btn-add-product");e==null||e.addEventListener("click",()=>wt()),t==null||t.addEventListener("click",async s=>{const n=s.target.closest('[data-action="edit"]'),a=s.target.closest('[data-action="delete"]');if(n){const o=parseInt(n.dataset.id),l=(await C()).find(r=>r.id===o);l&&wt(l)}if(a){const o=parseInt(a.dataset.id);ue(o)}})},wt=(t=null)=>{const e=!!t,s=`
    <div class="modal-header">
  ...
  `;L(s,"product-form"),setTimeout(()=>{var n,a,o;(n=document.getElementById("pf-close"))==null||n.addEventListener("click",()=>P("product-form")),(a=document.getElementById("pf-cancel"))==null||a.addEventListener("click",()=>P("product-form")),document.querySelectorAll(".emoji-pick").forEach(i=>{i.addEventListener("click",()=>{document.querySelectorAll(".emoji-pick").forEach(l=>{l.style.borderColor="var(--border-subtle)",l.classList.remove("emoji-pick--active")}),i.style.borderColor="var(--blue-400)",i.classList.add("emoji-pick--active"),document.getElementById("pf-emoji").value=i.dataset.emoji})}),(o=document.getElementById("pf-save"))==null||o.addEventListener("click",async()=>{var x,S,T,$,k,m;const i=(x=document.getElementById("pf-name"))==null?void 0:x.value.trim(),l=parseFloat((S=document.getElementById("pf-price"))==null?void 0:S.value)||0,r=((T=document.getElementById("pf-unit"))==null?void 0:T.value.trim())||"pcs",d=(($=document.getElementById("pf-category"))==null?void 0:$.value)||"Lainnya",c=((k=document.getElementById("pf-emoji"))==null?void 0:k.value)||"📦",b=parseInt((m=document.getElementById("pf-stock"))==null?void 0:m.value)||0;if(!i){window.showToast("Nama produk wajib diisi!","warning");return}if(l<=0){window.showToast("Harga harus lebih dari 0!","warning");return}try{e?(await Rt({...t,name:i,price:l,unit:r,category:d,emoji:c,stock:b}),window.showToast("Produk berhasil diperbarui","success")):(await Tt({name:i,price:l,unit:r,category:d,emoji:c,stock:b}),window.showToast("Produk berhasil ditambahkan","success")),P("product-form");const v=await C();g.setProducts(v),await tt()}catch(v){window.showToast("Gagal menyimpan produk!","error"),console.error("[products]",v)}})},0)},ue=t=>{L(`
    <div class="modal-header">
  ...
  `,"delete-confirm"),setTimeout(()=>{var s,n,a;(s=document.getElementById("dc-close"))==null||s.addEventListener("click",()=>P("delete-confirm")),(n=document.getElementById("dc-cancel"))==null||n.addEventListener("click",()=>P("delete-confirm")),(a=document.getElementById("dc-confirm"))==null||a.addEventListener("click",async()=>{try{await Kt(t);const o=await C();g.setProducts(o),P("delete-confirm"),await tt(),window.showToast("Produk dihapus","success")}catch(o){window.showToast("Gagal menghapus produk","error"),console.error("[products]",o)}})},0)};let nt=null;const me=async()=>{nt&&nt(),nt=g.on("transactions:change",t=>{Ct(t)}),await At()},At=async()=>{const t=await X();g.setTransactions(t),Ct(t)},Mt=t=>{const e=t.paymentMethod,s=t.paymentStatus;return e==="transfer"&&s==="transfer_pending"?'<span class="badge" style="background:#fef3c7;color:#92400e;border:1px solid #fcd34d">⏳ Pending</span>':e==="transfer"&&s==="transfer_confirmed"?'<span class="badge badge--green">✅ Confirmed</span>':s==="unpaid"?'<span class="badge" style="background:#fee2e2;color:#991b1b;border:1px solid #fca5a5">🔴 Belum Lunas</span>':s==="partial"?'<span class="badge" style="background:#fef3c7;color:#92400e;border:1px solid #fcd34d">🟡 Cicilan</span>':'<span class="badge badge--green">✅ Lunas</span>'},Nt=t=>t.paymentMethod==="cash"?"💵 Tunai":t.paymentMethod==="transfer"?"📲 Transfer":t.paymentMethod==="debt"?"📋 Hutang":f(t.paymentMethod)||"—",j=t=>!(t.paymentMethod==="debt"&&(t.remainingDebt||0)>0),Ct=t=>{const e=document.getElementById("view-transactions");if(!e)return;const s=[...t].sort((r,d)=>new Date(d.date)-new Date(r.date)),n=new Date().toISOString().split("T")[0],o=t.filter(r=>r.dateKey===n).reduce((r,d)=>d.paymentStatus==="paid"&&d.paymentMethod==="cash"||d.paymentStatus==="transfer_confirmed"?r+d.total:d.paymentMethod==="debt"?r+(d.paidAmount||0):r,0),i=t.reduce((r,d)=>r+(d.remainingDebt||0),0),l=t.filter(r=>r.paymentStatus==="transfer_pending").reduce((r,d)=>r+d.total,0);e.innerHTML=`
    <div class="section-header">
  ...
  `}).join(""):'<tr><td colspan="8" style="text-align:center;color:var(--text-muted);padding:32px;font-size:13px">Tidak ada transaksi untuk filter ini</td></tr>',ge=(t,e)=>{var s,n,a;(s=document.getElementById("tx-filter-date"))==null||s.addEventListener("change",o=>{const i=o.target.value,l=i?[...t].filter(d=>d.dateKey===i).sort((d,c)=>new Date(c.date)-new Date(d.date)):e,r=document.getElementById("tx-tbody");r&&(r.innerHTML=lt(l))}),(n=document.getElementById("tx-clear-filter"))==null||n.addEventListener("click",()=>{const o=document.getElementById("tx-tbody"),i=document.getElementById("tx-filter-date");o&&(o.innerHTML=lt(e)),i&&(i.value="")}),(a=document.getElementById("tx-table"))==null||a.addEventListener("click",async o=>{const i=o.target.closest("[data-action]");if(!i)return;const l=parseInt(i.dataset.id),r=i.dataset.action,d=t.find(c=>c.id===l);if(r==="detail"){d&&be(d);return}if(r==="confirm-transfer"){if(!d||!confirm(`Konfirmasi transfer ${p(d.total)} dari ${f(d.customerName||"pelanggan")} sudah diterima?`))return;try{const c={...d,paymentStatus:"transfer_confirmed",paidAmount:d.total,confirmedAt:new Date().toISOString()};await Y(c),g.updateTransaction(l,{paymentStatus:"transfer_confirmed",paidAmount:d.total,confirmedAt:c.confirmedAt}),window.showToast("Transfer dikonfirmasi! Kas bertambah.","success")}catch(c){console.error("[tx]",c),window.showToast("Gagal konfirmasi","error")}return}if(r==="pay-debt"){d&&ve(d);return}if(r==="delete"){if(!d)return;if(!j(d)){window.showToast("Tidak bisa hapus transaksi yang masih ada sisa hutang!","error");return}if(!confirm(`Hapus transaksi ${f(d.invoiceNo)}? Tindakan tidak bisa dibatalkan.`))return;try{await Ht(l),g.removeTransaction(l),window.showToast("Transaksi dihapus","success")}catch(c){console.error("[tx]",c),window.showToast("Gagal menghapus","error")}}})},ve=t=>{var n;const e=t.remainingDebt||0,s=`
    <div class="modal-header">
  ...
  `;L(a,"tx-detail"),setTimeout(()=>{var o,i,l,r;(o=document.getElementById("td-x"))==null||o.addEventListener("click",()=>P("tx-detail")),(i=document.getElementById("td-close-btn"))==null||i.addEventListener("click",()=>P("tx-detail")),(l=document.getElementById("btn-save-png"))==null||l.addEventListener("click",async()=>{var c;const d=document.getElementById("btn-save-png");d.textContent="⏳...",d.disabled=!0;try{const{default:b}=await V(async()=>{const{default:k}=await import("./vendor-pdf-j4-ZKoBl.js").then(m=>m.h);return{default:k}},[],import.meta.url),x=document.getElementById("receipt-capture"),S=await b(x,{backgroundColor:"#fff",scale:2,useCORS:!0,logging:!1}),T=await new Promise(k=>S.toBlob(k,"image/png")),$=`Struk-${t.invoiceNo||t.id}.png`;if((c=navigator.canShare)!=null&&c.call(navigator,{files:[new File([T],$,{type:"image/png"})]}))await navigator.share({title:`Struk ${t.invoiceNo}`,files:[new File([T],$,{type:"image/png"})]});else{const k=URL.createObjectURL(T);Object.assign(document.createElement("a"),{href:k,download:$}).click(),setTimeout(()=>URL.revokeObjectURL(k),2e3),window.showToast("PNG tersimpan!","success")}}catch(b){console.error("[png]",b),window.showToast("Gagal buat PNG","error")}finally{d.textContent="🖼️ PNG",d.disabled=!1}}),(r=document.getElementById("btn-save-pdf"))==null||r.addEventListener("click",()=>{const d=document.getElementById("receipt-capture");if(!d)return;const c=window.open("","_blank","width=400,height=700");if(!c){window.showToast("Popup diblokir browser. Ijinkan popup.","warning");return}c.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Struk ${f(t.invoiceNo||"")}</title>
      ...
      </head><body>${d.innerHTML}<script>window.onload=function(){window.print();window.onafterprint=function(){window.close()}}<\/script></body></html>`),c.document.close()})},0)};let st=null,J=null,W=null,D="semua";const ye=async()=>{st&&st(),st=g.on("transactions:change",t=>{gt(t)}),await mt()},mt=async()=>{const t=await X();g.setTransactions(t),gt(t)},gt=t=>{var h,w;const e=document.getElementById("view-reports");if(!e)return;const s=G(),n=Xt(),a=t.filter(y=>y.dateKey===s),o=a.reduce((y,u)=>y+u.total,0),i=a.length,l=t.filter(y=>{var u;return(u=y.dateKey)==null?void 0:u.startsWith(n)}),r=l.reduce((y,u)=>y+u.total,0),d=t.reduce((y,u)=>y+u.total,0),c=a.filter(y=>y.paymentMethod==="cash").reduce((y,u)=>y+u.total,0),b=a.filter(y=>y.paymentMethod==="transfer"&&y.paymentStatus==="transfer_confirmed").reduce((y,u)=>y+u.total,0),x=a.filter(y=>y.paymentMethod==="transfer"&&y.paymentStatus==="transfer_pending").reduce((y,u)=>y+u.total,0),S=a.filter(y=>y.paymentMethod==="debt").reduce((y,u)=>y+u.total,0),T=t.reduce((y,u)=>{for(const _ of u.debtPayments||[])_.date&&_.date.split("T")[0]===s&&(y+=_.amount||0);return y},0),$=c+b+T,k=t.reduce((y,u)=>y+(u.remainingDebt||0),0);t.filter(y=>y.paymentStatus==="transfer_pending").reduce((y,u)=>y+u.total,0);const m=ke(a),v=xe(t);J&&(J.destroy(),J=null),W&&(W.destroy(),W=null),e.innerHTML=`
    <div class="section-header">
      <div>
    ...
    <div class="stats-grid" style="grid-template-columns:repeat(auto-fit,minmax(180px,1fr))">
      ...
      <div class="stat-card" style="border-left:4px solid #16a34a">
        <span class="stat-card__icon">💵</span>
        <div class="stat-card__value" style="color:#16a34a">${p($)}</div>
      ...
      <div class="stat-card" style="border-left:4px solid #8b5cf6">
        <span class="stat-card__icon">💰</span>
        <div class="stat-card__value" style="color:#8b5cf6">${p(T)}</div>
      ...
      <div class="card">
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <strong style="color:#7c3aed">${p(T)}</strong>
          </div>
        ...
        <div style="margin-top:16px;display:flex;align-items:center;justify-content:center;height:140px">
          ${c+b+S+T>0?'<canvas id="chart-donut" width="140" height="140"></canvas>':'<div style="color:var(--text-muted);font-size:12px;text-align:center">Belum ada transaksi hari ini</div>'}
        </div>
      </div>
  ...
  `,(h=document.getElementById("btn-refresh-reports"))==null||h.addEventListener("click",mt),(w=document.getElementById("btn-export-pdf-report"))==null||w.addEventListener("click",()=>we(t,s,n)),document.querySelectorAll("[data-rpt-filter]").forEach(y=>{y.addEventListener("click",()=>{D=y.dataset.rptFilter,gt(t)})}),requestAnimationFrame(()=>he(v,c,b,S,T))},fe=(t,e)=>{let s=[...t];e==="cash"&&(s=s.filter(a=>a.paymentMethod==="cash")),e==="transfer"&&(s=s.filter(a=>a.paymentMethod==="transfer")),e==="debt"&&(s=s.filter(a=>a.paymentMethod==="debt"));const n=s.sort((a,o)=>new Date(o.date)-new Date(a.date));return n.length?n.slice(0,50).map(a=>{const o=a.total||0;let i=0,l=0;a.paymentMethod==="cash"?i=o:a.paymentMethod==="transfer"?a.paymentStatus==="transfer_confirmed"?i=o:l=o:a.paymentMethod==="debt"&&(i=a.paidAmount||0,l=a.remainingDebt||0);const r=(a.items||[]).map(b=>{var x;return`${((x=b.product)==null?void 0:x.name)||"Item"} (${b.qty}x)`}).join(", "),d=a.paymentMethod==="debt"?l===0?'<span class="badge badge--green">✅ LUNAS</span>':`<span class="badge" style="background:#fee2e2;color:#991b1b">🔴 Sisa ${p(l)}</span>`:a.paymentStatus==="transfer_pending"?'<span class="badge" style="background:#fef3c7;color:#92400e">⏳ Pending</span>':'<span class="badge badge--green">✅ Lunas</span>',c=a.paymentMethod==="cash"?"💵 Tunai":a.paymentMethod==="transfer"?"📲 Transfer":"📋 Hutang";return`
      <tr>
    ...
    `}).join(""):'<tr><td colspan="8" style="text-align:center;padding:30px;color:var(--text-muted)">Tidak ada transaksi untuk filter ini</td></tr>'},he=async(t,e,s,n,a)=>{const{Chart:o,registerables:i}=await V(async()=>{const{Chart:c,registerables:b}=await import("./vendor-chart-19k6OvwP.js");return{Chart:c,registerables:b}},[],import.meta.url);o.register(...i);const l=document.getElementById("chart-bar");l&&(J=new o(l,{type:"bar",data:{labels:t.map(c=>c.label),datasets:[{label:"Omzet Harian (Rp)",data:t.map(c=>c.total),backgroundColor:t.map((c,b)=>b===6?"rgba(37,99,235,0.85)":"rgba(37,99,235,0.35)"),borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:c=>" "+p(c.raw)}}},scales:{y:{beginAtZero:!0,ticks:{callback:c=>p(c),font:{size:10},maxTicksLimit:5},grid:{color:"rgba(37,99,235,0.06)"}},x:{ticks:{font:{size:11}},grid:{display:!1}}}}}));const r=document.getElementById("chart-donut"),d=e+s+n+a;r&&d>0&&(W=new o(r,{type:"doughnut",data:{labels:["Tunai","Transfer","Piutang Baru","Cicilan Masuk"],datasets:[{data:[e,s,n,a],backgroundColor:["#10b981","#3b82f6","#ef4444","#8b5cf6"],borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!1,cutout:"65%",plugins:{legend:{display:!1},tooltip:{callbacks:{label:c=>` ${c.label}: ${p(c.raw)}`}}}}}))},we=async(t,e,s)=>{try{const n=document.getElementById("btn-export-pdf-report");n&&(n.textContent="⏳ Memproses PDF...",n.disabled=!0);const{jsPDF:a}=await V(async()=>{const{jsPDF:u}=await import("./vendor-pdf-j4-ZKoBl.js").then(_=>_.j);return{jsPDF:u}},[],import.meta.url),{default:o}=await V(async()=>{const{default:u}=await import("./jspdf.plugin.autotable-QkGqYg11.js").then(_=>_.j);return{default:u}},__vite__mapDeps([0,1,2]),import.meta.url),i=new a({orientation:"portrait",unit:"mm",format:"a4"}),l=g.state.settings,r=i.internal.pageSize.getWidth();i.setFontSize(16),i.setFont("helvetica","bold"),i.text(l.shopName||"Blue Mountain Refilling Station",r/2,16,{align:"center"}),i.setFontSize(10),i.setFont("helvetica","normal"),i.text("LAPORAN PENJUALAN & ANALISIS KEUANGAN LENGKAP",r/2,22,{align:"center"}),i.text(`Dicetak: ${new Date().toLocaleDateString("id-ID",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}`,r/2,27,{align:"center"});const d=t.filter(u=>u.dateKey===e),c=d.reduce((u,_)=>u+_.total,0),b=t.filter(u=>{var _;return(_=u.dateKey)==null?void 0:_.startsWith(s)}).reduce((u,_)=>u+_.total,0),x=t.reduce((u,_)=>u+_.total,0),S=d.filter(u=>u.paymentMethod==="cash").reduce((u,_)=>u+_.total,0),T=d.filter(u=>u.paymentMethod==="transfer"&&u.paymentStatus==="transfer_confirmed").reduce((u,_)=>u+_.total,0),$=t.reduce((u,_)=>{for(const B of _.debtPayments||[])B.date&&B.date.split("T")[0]===e&&(u+=B.amount||0);return u},0),k=S+T+$,m=t.reduce((u,_)=>u+(_.remainingDebt||0),0);i.setFontSize(11),i.setFont("helvetica","bold"),i.text("1. Ringkasan Kinerja Keuangan",14,35);const v=[["Omzet Gross Hari Ini",p(c)],["Kas Masuk Real Hari Ini (Tunai+TF+Cicilan)",p(k)],["Cicilan Piutang Terkumpul Hari Ini",p($)],["Total Piutang Belum Lunas (Semua Pelanggan)",p(m)],["Omzet Bulan Ini",p(b)],["Total Omzet All-Time",p(x)],["Jumlah Transaksi Hari Ini",`${d.length} transaksi`]];o(i,{startY:38,head:[["Indikator Keuangan","Nilai (Rp)"]],body:v,theme:"grid",headStyles:{fillColor:[30,58,138],textColor:255,fontStyle:"bold"},columnStyles:{1:{halign:"right",fontStyle:"bold"}},margin:{left:14,right:14}});const h=i.lastAutoTable.finalY+10;i.setFontSize(11),i.setFont("helvetica","bold"),i.text("2. Rincian Riwayat Transaksi & Pelunasan",14,h);const w=[...t].sort((u,_)=>new Date(_.date)-new Date(u.date)).slice(0,80);o(i,{startY:h+4,head:[["Invoice","Tanggal","Pelanggan","Metode","Total Tagihan","Terbayar","Sisa Piutang","Status"]],body:w.map(u=>{let _=u.paymentMethod==="cash"?u.total:u.paymentMethod==="transfer"?u.paymentStatus==="transfer_confirmed"?u.total:0:u.paidAmount||0,B=u.paymentMethod==="debt"?u.remainingDebt||0:u.paymentStatus==="transfer_pending"?u.total:0;return[u.invoiceNo||"-",new Date(u.date).toLocaleDateString("id-ID"),u.customerName||"—",u.paymentMethod==="cash"?"Tunai":u.paymentMethod==="transfer"?"Transfer":"Hutang",p(u.total),p(_),B>0?p(B):"—",u.paymentMethod==="debt"?B===0?"Lunas":"Cicilan":u.paymentStatus==="transfer_pending"?"Pending":"Lunas"]}),theme:"striped",headStyles:{fillColor:[30,58,138],textColor:255,fontStyle:"bold",fontSize:8},bodyStyles:{fontSize:8},columnStyles:{4:{halign:"right"},5:{halign:"right"},6:{halign:"right"}},margin:{left:14,right:14}});const y=i.internal.getNumberOfPages();for(let u=1;u<=y;u++)i.setPage(u),i.setFontSize(8),i.setFont("helvetica","normal"),i.text(`Hal ${u} dari ${y} — ${l.shopName||"Blue Mountain POS"}`,r/2,i.internal.pageSize.getHeight()-8,{align:"center"});i.save(`Laporan-Keuangan-${e}.pdf`),window.showToast("Laporan PDF berhasil diekspor!","success")}catch(n){console.error("[pdf-report]",n),window.showToast("Gagal export PDF","error")}finally{const n=document.getElementById("btn-export-pdf-report");n&&(n.textContent="📄 Export PDF Laporan",n.disabled=!1)}},xe=t=>{const e=[];for(let s=6;s>=0;s--){const n=new Date;n.setDate(n.getDate()-s);const a=n.toISOString().split("T")[0],o=t.filter(l=>l.dateKey===a).reduce((l,r)=>l+r.total,0),i=new Intl.DateTimeFormat("id-ID",{weekday:"short"}).format(n);e.push({key:a,label:i,total:o})}return e},ke=t=>{var s;const e={};for(const n of t)for(const a of n.items||[]){if(!((s=a==null?void 0:a.product)!=null&&s.name))continue;const o=a.product.name;e[o]=(e[o]||0)+a.qty}return Object.entries(e).map(([n,a])=>({name:n,qty:a})).sort((n,a)=>a.qty-n.qty)},$e=async()=>{await Te(),await vt()},Te=async()=>{const t=["shopName","shopAddress","shopPhone","cashierName","printerUrl","printEnabled","taxRate","bankName","bankNumber","bankHolder","qrisNumber"],e={};for(const s of t){const n=await ct(s);n!==null&&(e[s]=n)}g.updateSettings(e)},vt=async()=>{const t=document.getElementById("view-settings"),e=g.state.settings,s="3.0.0",n=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0;t.innerHTML=`
    <div class="section-header">
  ...
  `,_e()},_e=()=>{var t,e,s,n,a,o,i,l;(t=document.getElementById("btn-export-backup"))==null||t.addEventListener("click",async()=>{const r=document.getElementById("btn-export-backup");r&&(r.textContent="⏳ Menyiapkan...",r.disabled=!0);try{const d=await Jt(),c=JSON.stringify(d,null,2),b=new Blob([c],{type:"application/json;charset=utf-8"}),x=new Date().toISOString().replace(/[-:T]/g,"").slice(0,14),T=`Backup-KASIR-${(d.shopName||"KASIR").replace(/[^a-zA-Z0-9]/g,"_")}-${x}.json`,$=URL.createObjectURL(b),k=document.createElement("a");k.href=$,k.download=T,document.body.appendChild(k),k.click(),document.body.removeChild(k),setTimeout(()=>URL.revokeObjectURL($),5e3),window.showToast("✅ File backup berhasil diunduh!","success")}catch(d){console.error("[export-backup]",d),window.showToast("Gagal ekspor backup: "+(d.message||"Error"),"error")}finally{r&&(r.textContent="📥 Unduh Backup JSON",r.disabled=!1)}}),(e=document.getElementById("btn-trigger-import"))==null||e.addEventListener("click",()=>{var r;(r=document.getElementById("input-import-backup"))==null||r.click()}),(s=document.getElementById("input-import-backup"))==null||s.addEventListener("change",r=>{var b;const d=(b=r.target.files)==null?void 0:b[0];if(!d)return;const c=new FileReader;c.onload=async x=>{var S;try{const T=(S=x.target)==null?void 0:S.result,$=JSON.parse(T);if(!$.data||!$.data.products&&!$.data.transactions){window.showToast("Format file backup tidak valid!","error");return}const k=($.data.products||[]).length,m=($.data.transactions||[]).length,v=($.data.expenses||[]).length,h=$.exportedAt?new Date($.exportedAt).toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}):"Tidak diketahui",w=`
          <div class="modal-header">
          ...
          <div class="modal-body">
            <div style="padding:12px;background:#dbeafe;border-radius:10px;font-size:12px;color:#1e40af;margin-bottom:12px">
              ...
              Toko: <strong>${f($.shopName||"Blue Mountain")}</strong><br>
              Waktu Ekspor: ${h}
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:14px;text-align:center">
              <div style="padding:8px;background:var(--bg-elevated);border-radius:8px;border:1px solid var(--border-subtle)">
                ...
                <div style="font-size:16px;font-weight:900;color:var(--blue-700)">${k}</div>
              </div>
              <div style="padding:8px;background:var(--bg-elevated);border-radius:8px;border:1px solid var(--border-subtle)">
        ...
        `;L(w,"import-confirm-modal"),setTimeout(()=>{var y,u,_;(y=document.getElementById("imp-x"))==null||y.addEventListener("click",()=>P("import-confirm-modal")),(u=document.getElementById("imp-cancel"))==null||u.addEventListener("click",()=>P("import-confirm-modal")),(_=document.getElementById("imp-confirm"))==null||_.addEventListener("click",async()=>{var N;const B=((N=document.querySelector('input[name="import-mode"]:checked'))==null?void 0:N.value)||"replace",M=document.getElementById("imp-confirm");M&&(M.textContent="⏳ Memulihkan...",M.disabled=!0);try{await Wt($,B);const[A,I,K]=await Promise.all([C(),X(),_t()]);g.setProducts(A),g.setTransactions(I),g.setExpenses(K),P("import-confirm-modal"),window.showToast("🎉 Data berhasil dipulihkan & sinkron!","success"),setTimeout(()=>vt(),600)}catch(A){console.error("[import-backup]",A),window.showToast("Gagal memulihkan data: "+A.message,"error")}})},0)}catch(T){console.error("[parse-backup]",T),window.showToast("File JSON rusak atau tidak terbaca!","error")}},c.readAsText(d),r.target.value=""}),(n=document.getElementById("btn-save-settings"))==null||n.addEventListener("click",async()=>{const r=["shopName","shopAddress","shopPhone","cashierName","taxRate","bankName","bankNumber","bankHolder","printerUrl","qrisNumber"],d={};for(const b of r){const x=document.getElementById(`set-${b}`);x&&(d[b]=b==="taxRate"?parseFloat(x.value)||0:x.value.trim(),await rt(b,d[b]))}const c=document.getElementById("set-printEnabled");c&&(d.printEnabled=c.checked,await rt("printEnabled",c.checked)),g.updateSettings(d),window.showToast("Pengaturan berhasil disimpan","success")}),(a=document.getElementById("btn-printer-guide"))==null||a.addEventListener("click",()=>{Ee()}),(o=document.getElementById("btn-install-pwa"))==null||o.addEventListener("click",()=>{window._pwaPrompt?window._pwaPrompt.prompt():window.showToast("Buka di Chrome / Edge untuk meng-install aplikasi ini","info")}),(i=document.getElementById("btn-clear-cache"))==null||i.addEventListener("click",async()=>{try{if("caches"in window){const r=await caches.keys();await Promise.all(r.map(d=>caches.delete(d)))}if("serviceWorker"in navigator){const r=await navigator.serviceWorker.getRegistrations();for(const d of r)await d.unregister()}window.showToast("Cache dihapus. Memperbarui...","success"),setTimeout(()=>window.location.reload(),1e3)}catch(r){console.error("[cache]",r),window.showToast("Gagal hapus cache","error")}}),(l=document.getElementById("btn-reset-all"))==null||l.addEventListener("click",async()=>{if(confirm(`⚠️ HAPUS SEMUA DATA?

Semua transaksi, pengeluaran, dan produk akan dihapus permanen.
Tindakan ini TIDAK dapat dibatalkan!`))try{await Gt(),window.showToast("Semua data berhasil dihapus. Reloading...","error"),setTimeout(()=>window.location.reload(),1500)}catch(d){console.error("[reset]",d),window.showToast("Gagal menghapus data","error")}})},Ee=()=>{L(`
    <div class="modal-header">
  ...
  `,"printer-guide"),setTimeout(()=>{var e,s;(e=document.getElementById("pg-close"))==null||e.addEventListener("click",()=>P("printer-guide")),(s=document.getElementById("pg-close2"))==null||s.addEventListener("click",()=>P("printer-guide"))},0)};let it=null,ot=null,H=!1;const Se=async()=>{it&&it(),ot&&ot(),it=g.on("transactions:change",()=>{H||R()}),ot=g.on("expenses:change",()=>{H||R()}),await R()},R=async()=>{if(!H){H=!0;try{const t=document.getElementById("view-finance");if(!t)return;const[e,s,n]=await Promise.all([g.state.transactions.length?Promise.resolve(g.state.transactions):X().then(m=>(g.setTransactions(m),m)),_t().then(m=>(g.setExpenses(m),m)),ct("modalAwal")]),a=parseFloat(n)||0;let o=0,i=0,l=0,r=0,d=0;for(const m of e)if(m.paymentMethod==="cash"&&(m.paymentStatus==="paid"||!m.paymentStatus)&&(o+=m.total),m.paymentMethod==="transfer"&&(m.paymentStatus==="transfer_confirmed"?i+=m.total:r+=m.total),m.paymentMethod==="debt"){for(const v of m.debtPayments||[])l+=v.amount;d+=m.remainingDebt||0}const c=o+i+l,b=s.reduce((m,v)=>m+(v.amount||0),0),x=a+c-b,S=r+d,T=Pe(e,s),$=Be(e,s),k=[...e.filter(m=>m.paymentStatus==="transfer_pending"),...e.filter(m=>(m.paymentMethod==="debt"||m.paymentStatus==="partial"||m.paymentStatus==="unpaid")&&(m.remainingDebt||0)>0)].sort((m,v)=>new Date(m.date)-new Date(v.date));t.innerHTML=`
      <div class="section-header">
      ...
      <div class="card" style="margin-bottom:16px">
        ...
        <div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
          <table class="data-table" id="piutang-table">
            ...
            <tbody>
              ${k.map(m=>{const v=m.total||0,h=m.paymentStatus==="transfer_pending"?v:m.remainingDebt||0,w=v-h,y=Math.min(100,Math.max(0,Math.round(w/v*100))),u=(m.debtPayments||[]).length;return`
              <tr>
...
`,Pe=(t,e)=>{const s={};for(const a of t){const o=a.dateKey;if(o){if(s[o]||(s[o]={masuk:0,keluar:0}),a.paymentMethod==="cash"&&(a.paymentStatus==="paid"||!a.paymentStatus)&&(s[o].masuk+=a.total),a.paymentMethod==="transfer"&&a.paymentStatus==="transfer_confirmed"){const i=a.confirmedAt?a.confirmedAt.split("T")[0]:o;s[i]||(s[i]={masuk:0,keluar:0}),s[i].masuk+=a.total}if(a.paymentMethod==="debt")for(const i of a.debtPayments||[]){const l=i.date?i.date.split("T")[0]:o;s[l]||(s[l]={masuk:0,keluar:0}),s[l].masuk+=i.amount}}}for(const a of e){const o=a.dateKey||(a.date?a.date.split("T")[0]:null);o&&(s[o]||(s[o]={masuk:0,keluar:0}),s[o].keluar+=a.amount||0)}const n=[];for(let a=29;a>=0;a--){const o=new Date;o.setDate(o.getDate()-a);const i=o.toISOString().split("T")[0];n.push({key:i,...s[i]||{masuk:0,keluar:0}})}return n},Ie=(t,e)=>{let s=e;const n=t.filter(a=>a.masuk>0||a.keluar>0).map(a=>{const o=a.masuk-a.keluar;return s+=o,`
    <tr>
    ...
    </tr>`});return n.length?n.join(""):'<tr><td colspan="5" style="text-align:center;padding:20px;color:var(--text-muted)">Tidak ada transaksi 30 hari terakhir</td></tr>'},Be=(t,e)=>{const s=[];for(const n of t){const a=f(n.customerName||"Pelanggan");if(n.paymentMethod==="cash")s.push({date:n.date,desc:`Penjualan Tunai — ${n.invoiceNo} (${a})`,debit:n.total,credit:n.total,account:"Kas / Penjualan",type:"kas"});else if(n.paymentMethod==="transfer")n.paymentStatus==="transfer_confirmed"?s.push({date:n.confirmedAt||n.date,desc:`Transfer Terkonfirmasi — ${n.invoiceNo} (${a})`,debit:n.total,credit:n.total,account:"Bank / Penjualan",type:"kas"}):s.push({date:n.date,desc:`Transfer Pending — ${n.invoiceNo} (${a}) [Menunggu Konfirmasi]`,debit:n.total,credit:n.total,account:"Piutang Transfer",type:"piutang"});else if(n.paymentMethod==="debt"){s.push({date:n.date,desc:`Penjualan Piutang Usaha — ${n.invoiceNo} (${a}) [Total Tagihan: ${p(n.total)}]`,debit:n.total,credit:n.total,account:"Piutang / Penjualan",type:"piutang"});const o=n.debtPayments||[];let i=0;o.forEach((l,r)=>{i+=l.amount||0;const d=Math.max(0,n.total-i),c=d===0,b=r+1,x=c?`Pelunasan (#${b}/LUNAS ✅)`:`Cicilan #${b} (dari ${o.length})`,S=l.note?` — ${f(l.note)}`:"";s.push({date:l.date,desc:`${x} — ${n.invoiceNo} (${a})${S} [Bayar: ${p(l.amount)} | Sisa: ${p(d)}]`,debit:l.amount,credit:l.amount,account:c?"Kas / Piutang (LUNAS ✅)":"Kas / Piutang Usaha",type:"kas"})})}}for(const n of e)s.push({date:n.date,desc:`Beban ${f(n.category||"Operasional")} — ${f(n.note||"Pengeluaran kas")}`,debit:n.amount,credit:n.amount,account:`Beban (${f(n.category||"Operasional")}) / Kas`,type:"beban"});return s.sort((n,a)=>new Date(a.date)-new Date(n.date))},Le=t=>{var e,s,n,a,o;(e=document.getElementById("btn-refresh-finance"))==null||e.addEventListener("click",R),(s=document.getElementById("btn-set-modal-awal"))==null||s.addEventListener("click",()=>{const l=`
    ...
    `;L(l,"modal-awal"),setTimeout(()=>{var r,d,c;(r=document.getElementById("ma-x"))==null||r.addEventListener("click",()=>P("modal-awal")),(d=document.getElementById("ma-cancel"))==null||d.addEventListener("click",()=>P("modal-awal")),(c=document.getElementById("ma-save"))==null||c.addEventListener("click",async()=>{var x;const b=parseFloat((x=document.getElementById("modal-awal-input"))==null?void 0:x.value)||0;await rt("modalAwal",b),g.updateSettings({modalAwal:b}),P("modal-awal"),window.showToast("Modal Awal disimpan!","success"),R()})},0)}),(n=document.getElementById("btn-add-expense"))==null||n.addEventListener("click",()=>{const l=`
    ...
    `;L(l,"expense-modal"),setTimeout(()=>{var r,d,c;(r=document.getElementById("exp-x"))==null||r.addEventListener("click",()=>P("expense-modal")),(d=document.getElementById("exp-cancel"))==null||d.addEventListener("click",()=>P("expense-modal")),(c=document.getElementById("exp-save"))==null||c.addEventListener("click",async()=>{var k,m,v,h;const b=parseFloat((k=document.getElementById("exp-amount"))==null?void 0:k.value)||0,x=((m=document.getElementById("exp-category"))==null?void 0:m.value)||"Lainnya",S=((h=(v=document.getElementById("exp-note"))==null?void 0:v.value)==null?void 0:h.trim())||"";if(b<=0){window.showToast("Jumlah harus lebih dari 0!","warning");return}const T=new Date().toISOString(),$={date:T,dateKey:T.split("T")[0],category:x,note:S,amount:b};try{const w=await Ft($);$.id=w,g.addExpense($),P("expense-modal"),window.showToast("Pengeluaran dicatat!","success")}catch(w){console.error("[expense]",w),window.showToast("Gagal simpan pengeluaran","error")}})},0)}),(a=document.getElementById("expense-table"))==null||a.addEventListener("click",async i=>{const l=i.target.closest('[data-action="delete-expense"]');if(!l||!confirm("Hapus pengeluaran ini?"))return;const r=parseInt(l.dataset.id);try{await qt(r),g.removeExpense(r),window.showToast("Pengeluaran dihapus","success")}catch(d){console.error("[expense]",d),window.showToast("Gagal hapus","error")}}),(o=document.getElementById("piutang-table"))==null||o.addEventListener("click",async i=>{const l=i.target.closest("[data-action]");if(!l)return;const r=parseInt(l.dataset.id),d=l.dataset.action,c=(g.state.transactions||t).find(b=>b.id===r);if(c){if(d==="confirm-transfer"){if(!confirm(`Konfirmasi transfer ${p(c.total)} dari ${f(c.customerName||"pelanggan")} sudah diterima?`))return;const b={...c,paymentStatus:"transfer_confirmed",paidAmount:c.total,confirmedAt:new Date().toISOString()};try{await Y(b),g.updateTransaction(r,{paymentStatus:"transfer_confirmed",paidAmount:c.total,confirmedAt:b.confirmedAt}),window.showToast("Transfer dikonfirmasi! Kas bertambah.","success")}catch(x){console.error("[confirm]",x),window.showToast("Gagal konfirmasi","error")}}if(d==="pay-debt"){const b=c.remainingDebt||0,x=`
      ...
      `;L(x,"mini-cicil"),setTimeout(()=>{var S,T,$;(S=document.getElementById("mc-x"))==null||S.addEventListener("click",()=>P("mini-cicil")),(T=document.getElementById("mc-cancel"))==null||T.addEventListener("click",()=>P("mini-cicil")),($=document.getElementById("mc-save"))==null||$.addEventListener("click",async()=>{var M,N,A;const k=parseFloat((M=document.getElementById("mc-amount"))==null?void 0:M.value)||0;if(k<=0||k>b){window.showToast("Jumlah tidak valid","warning");return}const m=(c.paidAmount||0)+k,v=Math.max(0,b-k),h=v===0?"paid":"partial",w=(c.debtPayments||[]).length+1,y=v===0?`Pelunasan (#${w}/LUNAS ✅)`:`Cicilan #${w}`,u=((A=(N=document.getElementById("mc-note"))==null?void 0:N.value)==null?void 0:A.trim())||y,_=[...c.debtPayments||[],{date:new Date().toISOString(),amount:k,note:u}],B={...c,paidAmount:m,remainingDebt:v,paymentStatus:h,debtPayments:_};try{await Y(B),g.updateTransaction(r,{paidAmount:m,remainingDebt:v,paymentStatus:h,debtPayments:_}),P("mini-cicil"),window.showToast(v===0?"🎉 Hutang LUNAS!":`Cicilan #${w} (${p(k)}) dicatat`,"success")}catch(I){console.error("[cicil]",I),window.showToast("Gagal simpan cicilan","error")}})},0)}}})};window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),window._pwaPrompt=t});const bt=()=>{const t=document.getElementById("status-badge");t&&(navigator.onLine?(t.textContent="Sistem Online",t.classList.remove("status-badge--offline")):(t.textContent="Mode Offline",t.classList.add("status-badge--offline")))};window.addEventListener("online",bt);window.addEventListener("offline",bt);window.showToast=(t,e="info",s="")=>{const n=document.getElementById("toast-container");if(!n)return;const a={success:"✅",error:"❌",warning:"⚠️",info:"ℹ️"},o=document.createElement("div");o.className=`toast toast--${e}`,o.setAttribute("role","alert"),o.innerHTML=`
    <span class="toast__icon">${a[e]??"ℹ️"}</span>
    <div class="toast__text">
      ${s?`<div class="toast__title">${s}</div>`:""}
      <div class="toast__msg">${t}</div>
    </div>
  `,n.appendChild(o);const i=()=>{o.classList.add("hiding"),o.addEventListener("animationend",()=>o.remove(),{once:!0})},l=setTimeout(i,3500);o.addEventListener("click",()=>{clearTimeout(l),i()})};const xt=()=>{const t=document.getElementById("topbar-time"),e=document.getElementById("topbar-date");t&&(t.textContent=Et()),e&&(e.textContent=Yt())},Ae={pos:{init:ne,refresh:re},products:{init:le,refresh:tt},transactions:{init:me,refresh:At},reports:{init:ye,refresh:mt},settings:{init:$e,refresh:vt},finance:{init:Se,refresh:R}},kt=new Set,$t=async t=>{const e=Ae[t];if(e){document.querySelectorAll(".dock-item").forEach(s=>{s.classList.toggle("active",s.dataset.view===t)}),document.querySelectorAll(".view").forEach(s=>{s.classList.toggle("active",s.id===`view-${t}`)});try{kt.has(t)?await e.refresh():(await e.init(),kt.add(t)),sessionStorage.setItem("activeView",t)}catch(s){console.error(`[Navigation] Error initializing view "${t}":`,s);const n=document.getElementById(`view-${t}`);n&&!n.children.length&&(n.innerHTML=`
      ...
      `)}g.navigate(t)}},Me=(t,e)=>{if(!t)return;const s=t.getBoundingClientRect(),n=Math.max(s.width,s.height),a=document.createElement("span");a.className="ripple-effect",a.style.cssText=`width:${n}px;height:${n}px;left:${e.clientX-s.left-n/2}px;top:${e.clientY-s.top-n/2}px`,t.style.position="relative",t.appendChild(a),a.addEventListener("animationend",()=>a.remove(),{once:!0})},zt=t=>{const e=(t==null?void 0:t.shopName)||"Blue Mountain Refilling Station";document.title=`${e} — Kasir POS`};g.on("settings:change",zt);document.addEventListener("focusin",t=>{t.target instanceof HTMLInputElement&&(t.target.type==="number"||t.target.inputMode==="numeric"||t.target.classList.contains("discount-input"))&&setTimeout(()=>{try{t.target.select()}catch{}},25)});const Ne=async()=>{try{await Vt(),await Ut()}catch(v){console.error("[DB] Failed to open database:",v),window.showToast("Database gagal dibuka. Coba reload halaman.","error","Database Error");return}const t=["shopName","shopAddress","shopPhone","cashierName","printEnabled","taxRate","printerUrl","bankName","bankNumber","bankHolder","qrisNumber","modalAwal"],e={};for(const v of t){const h=await ct(v);h!==null&&(v==="modalAwal"||v==="taxRate"?e[v]=parseFloat(h)||0:e[v]=h)}g.updateSettings(e),zt(g.state.settings),bt(),xt(),setInterval(xt,1e3);const s=document.querySelector(".dock"),n=[...document.querySelectorAll(".dock-item")],a=1.55,o=1.28,i=1.1,l=16,r=n.map(()=>1),d=n.map(()=>1);let c=null;const b=(v,h,w)=>v+(h-v)*w,x=.22,S=()=>{let v=!1;n.forEach((h,w)=>{r[w]=b(r[w],d[w],x),Math.abs(r[w]-d[w])>.001&&(v=!0);const y=r[w],u=(y-1)/(a-1)*l;h.style.transform=`translateY(${-u}px) scale(${y.toFixed(4)})`,h.style.zIndex=y>1.01?Math.round(y*10):""}),c=v?requestAnimationFrame(S):null},T=()=>{c||(c=requestAnimationFrame(S))},$=v=>{n.forEach((h,w)=>{const y=Math.abs(w-v);d[w]=y===0?a:y===1?o:y===2?i:1})},k=()=>n.forEach((v,h)=>d[h]=1);s==null||s.addEventListener("mousemove",v=>{let h=0,w=1/0;n.forEach((y,u)=>{const _=y.getBoundingClientRect(),B=Math.abs(v.clientX-(_.left+_.width/2));B<w&&(w=B,h=u)}),$(h),T()}),s==null||s.addEventListener("mouseleave",()=>{k(),T()}),n.forEach((v,h)=>{v.addEventListener("touchstart",()=>{$(h),T()},{passive:!0}),v.addEventListener("touchend",()=>{setTimeout(()=>{k(),T()},350)},{passive:!0})}),document.querySelectorAll(".dock-item").forEach(v=>{v.addEventListener("click",async h=>{const w=v.dataset.view;w&&(v.classList.add("bouncing"),v.addEventListener("animationend",()=>v.classList.remove("bouncing"),{once:!0}),Me(v.querySelector(".dock-icon"),h),await $t(w))})});const m=sessionStorage.getItem("activeView")||"pos";await $t(m)};document.addEventListener("DOMContentLoaded",Ne);
