...
const resetDatabase = async () => {
  console.log('🚀 [Supabase v1.0.0 Reset] Memulai pembersihan penuh database cloud...');
  ...
  const initialProducts = [
    { id: 'prod_galon_isi',    sku: 'BM-001', name: 'Air Isi Ulang Galon', category: 'Galon',   price: 5000,  unit: 'galon', emoji: '🪣', stock: 999 },
    { id: 'prod_antar_dalam',  sku: 'BM-002', name: 'Antar Galon (Dalam)', category: 'Galon',   price: 3000,  unit: 'kali',  emoji: '🛵', stock: 999 },
    { id: 'prod_antar_luar',   sku: 'BM-003', name: 'Antar Galon (Luar)',  category: 'Galon',   price: 5000,  unit: 'kali',  emoji: '🚚', stock: 999 },
    { id: 'prod_galon_aqua',   sku: 'BM-004', name: 'Galon Baru (Aqua)',   category: 'Galon',   price: 50000, unit: 'buah',  emoji: '💧', stock: 50 },
    { id: 'prod_galon_std',    sku: 'BM-005', name: 'Galon Baru (Standar)',category: 'Galon',   price: 45000, unit: 'buah',  emoji: '💦', stock: 50 },
    { id: 'prod_botol_600',    sku: 'BM-006', name: 'Air Botol 600ml',     category: 'Botol',   price: 3000,  unit: 'botol', emoji: '🍶', stock: 200 },
    { id: 'prod_botol_1500',   sku: 'BM-007', name: 'Air Botol 1500ml',    category: 'Botol',   price: 5000,  unit: 'botol', emoji: '🥤', stock: 100 },
    { id: 'prod_dispenser',    sku: 'BM-008', name: 'Dispenser Galon',     category: 'Lainnya', price: 250000,unit: 'unit',  emoji: '⚗️', stock: 10 },
  ];
  ...
  else console.log(`  ✓ ${initialProducts.length} Produk master bersih berhasil ditanamkan`);
  ...
  const initialSettings = [
    ...
    { key: 'qrisNumber',   value: '00020101021226590014ID.LINKAJA.WWW01189360091438493028300208101683935204581253033605802ID5913BLUE MOUNTAIN6007BANDUNG61054011562070703A0163046C49' },
    { key: 'modalAwal',    value: '100000' },
    { key: `users_roster_${DEFAULT_STORE_ID}`, value: JSON.stringify([{
      id: 'usr_admin',
      username: 'admin',
  ...
  else console.log('  ✓ Pengaturan toko & roster cloud v1.0.0 berhasil ditanamkan');
